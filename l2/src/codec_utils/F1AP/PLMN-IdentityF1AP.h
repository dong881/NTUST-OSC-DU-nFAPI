...
#ifndef	_PLMN_IdentityF1AP_H_
#define	_PLMN_IdentityF1AP_H_
...
/* PLMN-IdentityF1AP */
typedef OCTET_STRING_t	 PLMN_IdentityF1AP_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_PLMN_Identity_constr_1F1AP;
extern asn_TYPE_descriptor_t asn_DEF_PLMN_IdentityF1AP;
asn_struct_free_f PLMN_Identity_free;
asn_struct_print_f PLMN_Identity_print;
asn_constr_check_f PLMN_Identity_constraintF1AP;
