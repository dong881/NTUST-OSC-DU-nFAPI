...
#ifndef	_CellGroupConfigF1AP_H_
#define	_CellGroupConfigF1AP_H_
...
/* CellGroupConfig */
typedef OCTET_STRING_t	 CellGroupConfigF1AP_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_CellGroupConfigF1AP;
