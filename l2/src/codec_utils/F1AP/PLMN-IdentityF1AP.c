...
int
PLMN_Identity_constraintF1AP(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_PLMN_Identity_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	3	/* (SIZE(3..3)) */};
asn_per_constraints_t asn_PER_type_PLMN_Identity_constr_1F1AP CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_PLMN_IdentityF1AP = {
	"PLMN-IdentityF1AP",
	"PLMN-IdentityF1AP",
	&asn_OP_OCTET_STRING,
	...
	sizeof(asn_DEF_PLMN_Identity_tags_1)
		/sizeof(asn_DEF_PLMN_Identity_tags_1[0]), /* 1 */
	{ &asn_OER_type_PLMN_Identity_constr_1, &asn_PER_type_PLMN_Identity_constr_1F1AP, PLMN_Identity_constraintF1AP },
	0, 0,	/* No members */
