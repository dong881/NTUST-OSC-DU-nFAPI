...
typedef enum GeneralParametersMRDC_XDD_Diff__dummy {
	GeneralParametersMRDC_XDD_Diff__dummy_supported	= 0
} e_GeneralParametersMRDC_XDD_Diff__dummy;
...
/* extern asn_TYPE_descriptor_t asn_DEF_dummy_8;	// (Use -fall-defs-global to expose) */
