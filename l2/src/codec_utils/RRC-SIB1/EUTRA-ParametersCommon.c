...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_nr_HO_ToEN_DC_r16_constr_14 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_nr_HO_ToEN_DC_r16_value2enum_14[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_nr_HO_ToEN_DC_r16_enum2value_14[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_nr_HO_ToEN_DC_r16_specs_14 = {
	asn_MAP_nr_HO_ToEN_DC_r16_value2enum_14,	/* "tag" => N; sorted by tag */
	asn_MAP_nr_HO_ToEN_DC_r16_enum2value_14,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_nr_HO_ToEN_DC_r16_tags_14[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_nr_HO_ToEN_DC_r16_14 = {
	"nr-HO-ToEN-DC-r16",
	"nr-HO-ToEN-DC-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_nr_HO_ToEN_DC_r16_tags_14,
	sizeof(asn_DEF_nr_HO_ToEN_DC_r16_tags_14)
		/sizeof(asn_DEF_nr_HO_ToEN_DC_r16_tags_14[0]) - 1, /* 1 */
	asn_DEF_nr_HO_ToEN_DC_r16_tags_14,	/* Same as above */
	sizeof(asn_DEF_nr_HO_ToEN_DC_r16_tags_14)
		/sizeof(asn_DEF_nr_HO_ToEN_DC_r16_tags_14[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_nr_HO_ToEN_DC_r16_constr_14,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_nr_HO_ToEN_DC_r16_specs_14	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_13[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_ParametersCommon__ext2, nr_HO_ToEN_DC_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_nr_HO_ToEN_DC_r16_14,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_13 = {
	sizeof(struct EUTRA_ParametersCommon__ext2),
	offsetof(struct EUTRA_ParametersCommon__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_ParametersCommon_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_ParametersCommon, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_10,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_ParametersCommon, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_13,
		0,
