...
typedef struct CSI_SSB_ResourceSet {
	 ...
	 */
	struct CSI_SSB_ResourceSet__ext1 {
		struct CSI_SSB_ResourceSet__ext1__servingAdditionalPCIList_r17 {
			A_SEQUENCE_OF(ServingAdditionalPCIIndex_r17_t) list;
...
extern asn_TYPE_member_t asn_MBR_CSI_SSB_ResourceSet_1[3];
