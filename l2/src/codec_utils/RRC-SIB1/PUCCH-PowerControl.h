...
struct SetupRelease_PathlossReferenceRSs_v1610;
...
typedef struct PUCCH_PowerControl {
	 ...
	 */
	struct PUCCH_PowerControl__ext1 {
		struct SetupRelease_PathlossReferenceRSs_v1610	*pathlossReferenceRSs_v1610;	/* OPTIONAL */
