...
static int
memb_searchSpaceSwitchTimer_r16_constraint_4(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_searchSpaceSwitchTimer_v1710_constraint_7(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_searchSpaceSwitchTimer_r16_constr_6 CC_NOTUSED = {
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_searchSpaceSwitchTimer_v1710_constr_8 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ext1_4[] = {
	{ ATF_POINTER, 2, offsetof(struct PDCCH_ServingCellConfig__ext1, availabilityIndicator_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_AvailabilityIndicator_r16,
		0,
		{
	...
	{ ATF_POINTER, 1, offsetof(struct PDCCH_ServingCellConfig__ext1, searchSpaceSwitchTimer_r16),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_searchSpaceSwitchTimer_r16_constr_6,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_searchSpaceSwitchTimer_r16_constraint_4
		},
		0, 0, /* No default value */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_4 = {
	sizeof(struct PDCCH_ServingCellConfig__ext1),
	offsetof(struct PDCCH_ServingCellConfig__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext2_7[] = {
	{ ATF_POINTER, 1, offsetof(struct PDCCH_ServingCellConfig__ext2, searchSpaceSwitchTimer_v1710),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_searchSpaceSwitchTimer_v1710_constr_8,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_searchSpaceSwitchTimer_v1710_constraint_7
		},
		0, 0, /* No default value */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_7 = {
	sizeof(struct PDCCH_ServingCellConfig__ext2),
	offsetof(struct PDCCH_ServingCellConfig__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PDCCH_ServingCellConfig_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct PDCCH_ServingCellConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_4,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct PDCCH_ServingCellConfig, ext2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext2_7,
		0,
