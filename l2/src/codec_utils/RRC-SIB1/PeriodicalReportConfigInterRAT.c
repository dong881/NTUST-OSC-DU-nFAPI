...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_includeCommonLocationInfo_r16_constr_18 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ext1_15[] = {
	{ ATF_POINTER, 1, offsetof(struct PeriodicalReportConfigInterRAT__ext1, reportQuantityUTRA_FDD_r16),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_15 = {
	sizeof(struct PeriodicalReportConfigInterRAT__ext1),
	offsetof(struct PeriodicalReportConfigInterRAT__ext1, _asn_ctx),
...
static const asn_INTEGER_enum_map_t asn_MAP_includeCommonLocationInfo_r16_value2enum_18[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_includeCommonLocationInfo_r16_enum2value_18[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_includeCommonLocationInfo_r16_specs_18 = {
	asn_MAP_includeCommonLocationInfo_r16_value2enum_18,	/* "tag" => N; sorted by tag */
	asn_MAP_includeCommonLocationInfo_r16_enum2value_18,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_includeCommonLocationInfo_r16_tags_18[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_includeCommonLocationInfo_r16_18 = {
	"includeCommonLocationInfo-r16",
	"includeCommonLocationInfo-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_includeCommonLocationInfo_r16_tags_18,
	sizeof(asn_DEF_includeCommonLocationInfo_r16_tags_18)
		/sizeof(asn_DEF_includeCommonLocationInfo_r16_tags_18[0]) - 1, /* 1 */
	asn_DEF_includeCommonLocationInfo_r16_tags_18,	/* Same as above */
	sizeof(asn_DEF_includeCommonLocationInfo_r16_tags_18)
		/sizeof(asn_DEF_includeCommonLocationInfo_r16_tags_18[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_includeCommonLocationInfo_r16_constr_18,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_includeCommonLocationInfo_r16_specs_18	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_17[] = {
	{ ATF_POINTER, 4, offsetof(struct PeriodicalReportConfigInterRAT__ext2, includeCommonLocationInfo_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_includeCommonLocationInfo_r16_18,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 3, offsetof(struct PeriodicalReportConfigInterRAT__ext2, includeBT_Meas_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_POINTER, 2, offsetof(struct PeriodicalReportConfigInterRAT__ext2, includeWLAN_Meas_r16),
	...
	{ ATF_POINTER, 1, offsetof(struct PeriodicalReportConfigInterRAT__ext2, includeSensor_Meas_r16),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_17 = {
	sizeof(struct PeriodicalReportConfigInterRAT__ext2),
	offsetof(struct PeriodicalReportConfigInterRAT__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext3_23[] = {
	{ ATF_POINTER, 1, offsetof(struct PeriodicalReportConfigInterRAT__ext3, reportQuantityRelay_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_23 = {
	sizeof(struct PeriodicalReportConfigInterRAT__ext3),
	offsetof(struct PeriodicalReportConfigInterRAT__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PeriodicalReportConfigInterRAT_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct PeriodicalReportConfigInterRAT, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_15,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct PeriodicalReportConfigInterRAT, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_17,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct PeriodicalReportConfigInterRAT, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_23,
		0,
...
static const int asn_MAP_PeriodicalReportConfigInterRAT_oms_1[] = { 4, 5, 6 };
