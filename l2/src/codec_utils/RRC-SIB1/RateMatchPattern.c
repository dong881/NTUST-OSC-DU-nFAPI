...
static asn_TYPE_member_t asn_MBR_ext1_24[] = {
	{ ATF_POINTER, 1, offsetof(struct RateMatchPattern__ext1, controlResourceSet_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_24 = {
	sizeof(struct RateMatchPattern__ext1),
	offsetof(struct RateMatchPattern__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RateMatchPattern_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RateMatchPattern, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_24,
		0,
