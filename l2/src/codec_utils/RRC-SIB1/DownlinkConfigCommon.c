...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct DownlinkConfigCommon__ext1, initialDownlinkBWP_RedCap_r17),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_5 = {
	sizeof(struct DownlinkConfigCommon__ext1),
	offsetof(struct DownlinkConfigCommon__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_DownlinkConfigCommon_1[] = {
	{ ATF_POINTER, 3, offsetof(struct DownlinkConfigCommon, frequencyInfoDL),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct DownlinkConfigCommon, initialDownlinkBWP),
	...
	{ ATF_POINTER, 1, offsetof(struct DownlinkConfigCommon, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
...
static const int asn_MAP_DownlinkConfigCommon_oms_1[] = { 0, 1, 2 };
