...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_nrofHARQ_ProcessesForPUSCH_r17_constr_16 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_maxMIMO_Layers_constr_11,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_maxMIMO_Layers_constraint_10
		},
...
static asn_TYPE_member_t asn_MBR_ext2_13[] = {
	{ ATF_POINTER, 1, offsetof(struct PUSCH_ServingCellConfig__ext2, maxMIMO_LayersDCI_0_2_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_MaxMIMO_LayersDCI_0_2_r16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_13 = {
	sizeof(struct PUSCH_ServingCellConfig__ext2),
	offsetof(struct PUSCH_ServingCellConfig__ext2, _asn_ctx),
...
static const asn_INTEGER_enum_map_t asn_MAP_nrofHARQ_ProcessesForPUSCH_r17_value2enum_16[] = {
	{ 0,	3,	"n32" }
};
static const unsigned int asn_MAP_nrofHARQ_ProcessesForPUSCH_r17_enum2value_16[] = {
	0	/* n32(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_nrofHARQ_ProcessesForPUSCH_r17_specs_16 = {
	asn_MAP_nrofHARQ_ProcessesForPUSCH_r17_value2enum_16,	/* "tag" => N; sorted by tag */
	asn_MAP_nrofHARQ_ProcessesForPUSCH_r17_enum2value_16,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_nrofHARQ_ProcessesForPUSCH_r17_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_nrofHARQ_ProcessesForPUSCH_r17_16 = {
	"nrofHARQ-ProcessesForPUSCH-r17",
	"nrofHARQ-ProcessesForPUSCH-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_nrofHARQ_ProcessesForPUSCH_r17_tags_16,
	sizeof(asn_DEF_nrofHARQ_ProcessesForPUSCH_r17_tags_16)
		/sizeof(asn_DEF_nrofHARQ_ProcessesForPUSCH_r17_tags_16[0]) - 1, /* 1 */
	asn_DEF_nrofHARQ_ProcessesForPUSCH_r17_tags_16,	/* Same as above */
	sizeof(asn_DEF_nrofHARQ_ProcessesForPUSCH_r17_tags_16)
		/sizeof(asn_DEF_nrofHARQ_ProcessesForPUSCH_r17_tags_16[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_nrofHARQ_ProcessesForPUSCH_r17_constr_16,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_nrofHARQ_ProcessesForPUSCH_r17_specs_16	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext3_15[] = {
	{ ATF_POINTER, 2, offsetof(struct PUSCH_ServingCellConfig__ext3, nrofHARQ_ProcessesForPUSCH_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_nrofHARQ_ProcessesForPUSCH_r17_16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct PUSCH_ServingCellConfig__ext3, uplinkHARQ_mode_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_UplinkHARQ_mode_r17,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_15 = {
	sizeof(struct PUSCH_ServingCellConfig__ext3),
	offsetof(struct PUSCH_ServingCellConfig__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PUSCH_ServingCellConfig_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct PUSCH_ServingCellConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_10,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct PUSCH_ServingCellConfig, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_13,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct PUSCH_ServingCellConfig, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext3_15,
		0,
