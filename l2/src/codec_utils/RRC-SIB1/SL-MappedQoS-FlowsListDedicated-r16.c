...
static asn_SET_OF_specifics_t asn_SPC_sl_MappedQoS_FlowsToReleaseList_r16_specs_4 = {
	sizeof(struct SL_MappedQoS_FlowsListDedicated_r16__sl_MappedQoS_FlowsToReleaseList_r16),
	offsetof(struct SL_MappedQoS_FlowsListDedicated_r16__sl_MappedQoS_FlowsToReleaseList_r16, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
asn_TYPE_member_t asn_MBR_SL_MappedQoS_FlowsListDedicated_r16_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SL_MappedQoS_FlowsListDedicated_r16, sl_MappedQoS_FlowsToReleaseList_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
