 ...
 */
static int
memb_aperiodicTriggeringOffset_r16_constraint_12(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static int
memb_aperiodicTriggeringOffset_r17_constraint_14(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_aperiodicTriggeringOffsetL2_r17_constraint_14(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_aperiodicTriggeringOffset_r16_constr_13 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_pdc_Info_r17_constr_15 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_aperiodicTriggeringOffset_r17_constr_18 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_aperiodicTriggeringOffsetL2_r17_constr_19 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 5,  5,  0,  31 }	/* (0..31) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_ext1_12[] = {
	{ ATF_POINTER, 1, offsetof(struct NZP_CSI_RS_ResourceSet__ext1, aperiodicTriggeringOffset_r16),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_aperiodicTriggeringOffset_r16_constr_13,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_aperiodicTriggeringOffset_r16_constraint_12
		},
		0, 0, /* No default value */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_12 = {
	sizeof(struct NZP_CSI_RS_ResourceSet__ext1),
	offsetof(struct NZP_CSI_RS_ResourceSet__ext1, _asn_ctx),
...
static const asn_INTEGER_enum_map_t asn_MAP_pdc_Info_r17_value2enum_15[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_pdc_Info_r17_enum2value_15[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_pdc_Info_r17_specs_15 = {
	asn_MAP_pdc_Info_r17_value2enum_15,	/* "tag" => N; sorted by tag */
	asn_MAP_pdc_Info_r17_enum2value_15,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_pdc_Info_r17_tags_15[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_pdc_Info_r17_15 = {
	"pdc-Info-r17",
	"pdc-Info-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_pdc_Info_r17_tags_15,
	sizeof(asn_DEF_pdc_Info_r17_tags_15)
		/sizeof(asn_DEF_pdc_Info_r17_tags_15[0]) - 1, /* 1 */
	asn_DEF_pdc_Info_r17_tags_15,	/* Same as above */
	sizeof(asn_DEF_pdc_Info_r17_tags_15)
		/sizeof(asn_DEF_pdc_Info_r17_tags_15[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_pdc_Info_r17_constr_15,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_pdc_Info_r17_specs_15	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_14[] = {
	{ ATF_POINTER, 4, offsetof(struct NZP_CSI_RS_ResourceSet__ext2, pdc_Info_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_pdc_Info_r17_15,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 3, offsetof(struct NZP_CSI_RS_ResourceSet__ext2, cmrGroupingAndPairing_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct NZP_CSI_RS_ResourceSet__ext2, aperiodicTriggeringOffset_r17),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_aperiodicTriggeringOffset_r17_constr_18,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_aperiodicTriggeringOffset_r17_constraint_14
		},
		0, 0, /* No default value */
		"aperiodicTriggeringOffset-r17"
		},
	{ ATF_POINTER, 1, offsetof(struct NZP_CSI_RS_ResourceSet__ext2, aperiodicTriggeringOffsetL2_r17),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_aperiodicTriggeringOffsetL2_r17_constr_19,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_aperiodicTriggeringOffsetL2_r17_constraint_14
		},
		0, 0, /* No default value */
		"aperiodicTriggeringOffsetL2-r17"
		},
};
static const int asn_MAP_ext2_oms_14[] = { 0, 1, 2, 3 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_14 = {
	sizeof(struct NZP_CSI_RS_ResourceSet__ext2),
	offsetof(struct NZP_CSI_RS_ResourceSet__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_NZP_CSI_RS_ResourceSet_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct NZP_CSI_RS_ResourceSet, repetition),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct NZP_CSI_RS_ResourceSet, aperiodicTriggeringOffset),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct NZP_CSI_RS_ResourceSet, trs_Info),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_trs_Info_9,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct NZP_CSI_RS_ResourceSet, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext1_12,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NZP_CSI_RS_ResourceSet, ext2),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext2_14,
		0,
...
static const int asn_MAP_NZP_CSI_RS_ResourceSet_oms_1[] = { 2, 3, 4, 5, 6 };
