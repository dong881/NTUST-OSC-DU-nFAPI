...
static int
memb_overheatingAssistanceSCG_r16_constraint_5(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_overheatingAssistanceSCG_FR2_2_r17_constraint_7(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const OCTET_STRING_t *st = (const OCTET_STRING_t *)sptr;
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_overheatingAssistanceSCG_r16_constr_6 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_overheatingAssistanceSCG_FR2_2_r17_constr_8 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_SEMI_CONSTRAINED,	-1, -1,  0,  0 }	/* (SIZE(0..MAX)) */,
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct MRDC_AssistanceInfo__ext1, overheatingAssistanceSCG_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_overheatingAssistanceSCG_r16_constr_6,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_overheatingAssistanceSCG_r16_constraint_5
		},
		0, 0, /* No default value */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_5 = {
	sizeof(struct MRDC_AssistanceInfo__ext1),
	offsetof(struct MRDC_AssistanceInfo__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext2_7[] = {
	{ ATF_POINTER, 1, offsetof(struct MRDC_AssistanceInfo__ext2, overheatingAssistanceSCG_FR2_2_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_overheatingAssistanceSCG_FR2_2_r17_constr_8,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_overheatingAssistanceSCG_FR2_2_r17_constraint_7
		},
		0, 0, /* No default value */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_7 = {
	sizeof(struct MRDC_AssistanceInfo__ext2),
	offsetof(struct MRDC_AssistanceInfo__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MRDC_AssistanceInfo_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct MRDC_AssistanceInfo, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct MRDC_AssistanceInfo, ext2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext2_7,
		0,
...
static const int asn_MAP_MRDC_AssistanceInfo_oms_1[] = { 1, 2 };
...
asn_SEQUENCE_specifics_t asn_SPC_MRDC_AssistanceInfo_specs_1 = {
	...
	asn_MAP_MRDC_AssistanceInfo_oms_1,	/* Optional members */
	0, 2,	/* Root/Additions */
	1,	/* First extension addition */
};
