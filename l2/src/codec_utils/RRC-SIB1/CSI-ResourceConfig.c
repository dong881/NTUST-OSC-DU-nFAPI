...
static asn_TYPE_member_t asn_MBR_ext1_17[] = {
	{ ATF_POINTER, 1, offsetof(struct CSI_ResourceConfig__ext1, csi_SSB_ResourceSetListExt_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_17 = {
	sizeof(struct CSI_ResourceConfig__ext1),
	offsetof(struct CSI_ResourceConfig__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_CSI_ResourceConfig_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CSI_ResourceConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_17,
		0,
...
static const int asn_MAP_CSI_ResourceConfig_oms_1[] = { 4 };
...
asn_SEQUENCE_specifics_t asn_SPC_CSI_ResourceConfig_specs_1 = {
	...
	asn_MAP_CSI_ResourceConfig_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */
