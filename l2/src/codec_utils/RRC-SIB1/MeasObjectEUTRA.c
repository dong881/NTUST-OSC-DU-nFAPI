...
static int
memb_excludedCellsToAddModListEUTRAN_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_excludedCellsToAddModListEUTRAN_constr_8 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_excludedCellsToAddModListEUTRAN_constr_8 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_excludedCellsToAddModListEUTRAN_8[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_excludedCellsToAddModListEUTRAN_tags_8[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_excludedCellsToAddModListEUTRAN_specs_8 = {
	sizeof(struct MeasObjectEUTRA__excludedCellsToAddModListEUTRAN),
	offsetof(struct MeasObjectEUTRA__excludedCellsToAddModListEUTRAN, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_excludedCellsToAddModListEUTRAN_8 = {
	"excludedCellsToAddModListEUTRAN",
	"excludedCellsToAddModListEUTRAN",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_excludedCellsToAddModListEUTRAN_tags_8,
	sizeof(asn_DEF_excludedCellsToAddModListEUTRAN_tags_8)
		/sizeof(asn_DEF_excludedCellsToAddModListEUTRAN_tags_8[0]) - 1, /* 1 */
	asn_DEF_excludedCellsToAddModListEUTRAN_tags_8,	/* Same as above */
	sizeof(asn_DEF_excludedCellsToAddModListEUTRAN_tags_8)
		/sizeof(asn_DEF_excludedCellsToAddModListEUTRAN_tags_8[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_excludedCellsToAddModListEUTRAN_constr_8,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	asn_MBR_excludedCellsToAddModListEUTRAN_8,
	1,	/* Single element */
	&asn_SPC_excludedCellsToAddModListEUTRAN_specs_8	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_14[] = {
	{ ATF_POINTER, 1, offsetof(struct MeasObjectEUTRA__ext1, associatedMeasGap_r17),
...
asn_TYPE_member_t asn_MBR_MeasObjectEUTRA_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct MeasObjectEUTRA, excludedCellsToRemoveListEUTRAN),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasObjectEUTRA, excludedCellsToAddModListEUTRAN),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_excludedCellsToAddModListEUTRAN_8,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_excludedCellsToAddModListEUTRAN_constr_8,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_excludedCellsToAddModListEUTRAN_constraint_1
		},
		0, 0, /* No default value */
		"excludedCellsToAddModListEUTRAN"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct MeasObjectEUTRA, ext1),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext1_14,
		0,
...
static const int asn_MAP_MeasObjectEUTRA_oms_1[] = { 2, 3, 4, 5, 7, 9 };
