...
static asn_TYPE_member_t asn_MBR_ext1_6[] = {
	{ ATF_POINTER, 2, offsetof(struct SL_BWP_Config_r16__ext1, sl_BWP_PoolConfigPS_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_SL_BWP_PoolConfig_r16,
		0,
		{
	...
	{ ATF_POINTER, 1, offsetof(struct SL_BWP_Config_r16__ext1, sl_BWP_DiscPoolConfig_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_SL_BWP_DiscPoolConfig_r17,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_6 = {
	sizeof(struct SL_BWP_Config_r16__ext1),
	offsetof(struct SL_BWP_Config_r16__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SL_BWP_Config_r16_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct SL_BWP_Config_r16, sl_BWP_Generic_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SL_BWP_Config_r16, sl_BWP_PoolConfig_r16),
	...
	{ ATF_POINTER, 1, offsetof(struct SL_BWP_Config_r16, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_6,
		0,
...
static const int asn_MAP_SL_BWP_Config_r16_oms_1[] = { 1, 2, 3 };
