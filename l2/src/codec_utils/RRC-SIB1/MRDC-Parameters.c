...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_intraBandENDC_Support_constr_23 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_dynamicPowerSharingENDC_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_dualPA_Architecture_constr_21,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static const asn_INTEGER_enum_map_t asn_MAP_intraBandENDC_Support_value2enum_23[] = {
	{ 0,	14,	"non-contiguous" },
	{ 1,	4,	"both" }
};
static const unsigned int asn_MAP_intraBandENDC_Support_enum2value_23[] = {
	1,	/* both(1) */
	0	/* non-contiguous(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_intraBandENDC_Support_specs_23 = {
	asn_MAP_intraBandENDC_Support_value2enum_23,	/* "tag" => N; sorted by tag */
	asn_MAP_intraBandENDC_Support_enum2value_23,	/* N => "tag"; sorted by N */
	2,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_intraBandENDC_Support_tags_23[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_intraBandENDC_Support_23 = {
	"intraBandENDC-Support",
	"intraBandENDC-Support",
	&asn_OP_NativeEnumerated,
	asn_DEF_intraBandENDC_Support_tags_23,
	sizeof(asn_DEF_intraBandENDC_Support_tags_23)
		/sizeof(asn_DEF_intraBandENDC_Support_tags_23[0]) - 1, /* 1 */
	asn_DEF_intraBandENDC_Support_tags_23,	/* Same as above */
	sizeof(asn_DEF_intraBandENDC_Support_tags_23)
		/sizeof(asn_DEF_intraBandENDC_Support_tags_23[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_intraBandENDC_Support_constr_23,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_intraBandENDC_Support_specs_23	/* Additional specs */
};
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_ul_TimingAlignmentEUTRA_NR_constr_26,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static asn_TYPE_member_t asn_MBR_ext1_20[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct MRDC_Parameters__ext1, intraBandENDC_Support),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_intraBandENDC_Support_23,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_TYPE_member_t asn_MBR_MRDC_Parameters_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct MRDC_Parameters, dynamicPowerSharingENDC),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
