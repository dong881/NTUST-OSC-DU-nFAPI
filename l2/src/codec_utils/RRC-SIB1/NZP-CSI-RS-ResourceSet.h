...
typedef enum NZP_CSI_RS_ResourceSet__ext2__pdc_Info_r17 {
	NZP_CSI_RS_ResourceSet__ext2__pdc_Info_r17_true	= 0
} e_NZP_CSI_RS_ResourceSet__ext2__pdc_Info_r17;

/* Forward declarations */
struct CMRGroupingAndPairing_r17;
...
typedef struct NZP_CSI_RS_ResourceSet {
	 ...
	 */
	struct NZP_CSI_RS_ResourceSet__ext1 {
		long	*aperiodicTriggeringOffset_r16;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext1;
	struct NZP_CSI_RS_ResourceSet__ext2 {
		long	*pdc_Info_r17;	/* OPTIONAL */
		struct CMRGroupingAndPairing_r17	*cmrGroupingAndPairing_r17;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_pdc_Info_r17_15;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_NZP_CSI_RS_ResourceSet_1[7];
