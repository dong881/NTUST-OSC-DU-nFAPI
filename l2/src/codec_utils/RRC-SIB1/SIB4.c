...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct SIB4__ext1, interFreqCarrierFreqList_v1610),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_5 = {
	sizeof(struct SIB4__ext1),
	offsetof(struct SIB4__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext2_7[] = {
	{ ATF_POINTER, 1, offsetof(struct SIB4__ext2, interFreqCarrierFreqList_v1700),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_7 = {
	sizeof(struct SIB4__ext2),
	offsetof(struct SIB4__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext3_9[] = {
	{ ATF_POINTER, 1, offsetof(struct SIB4__ext3, interFreqCarrierFreqList_v1720),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_9 = {
	sizeof(struct SIB4__ext3),
	offsetof(struct SIB4__ext3, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext4_11[] = {
	{ ATF_POINTER, 1, offsetof(struct SIB4__ext4, interFreqCarrierFreqList_v1730),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ext4_oms_11[] = { 0 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext4_specs_11 = {
	sizeof(struct SIB4__ext4),
	offsetof(struct SIB4__ext4, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SIB4_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct SIB4, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 4, offsetof(struct SIB4, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct SIB4, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext2_7,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SIB4, ext3),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext3_9,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SIB4, ext4),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext4_11,
		0,
...
static const int asn_MAP_SIB4_oms_1[] = { 1, 2, 3, 4, 5 };
