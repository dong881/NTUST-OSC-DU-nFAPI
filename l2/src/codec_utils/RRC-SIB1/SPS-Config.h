...
typedef enum SPS_Config__ext1__pdsch_AggregationFactor_r16 {
	SPS_Config__ext1__pdsch_AggregationFactor_r16_n1	= 0,
	SPS_Config__ext1__pdsch_AggregationFactor_r16_n2	= 1,
	SPS_Config__ext1__pdsch_AggregationFactor_r16_n4	= 2,
	SPS_Config__ext1__pdsch_AggregationFactor_r16_n8	= 3
} e_SPS_Config__ext1__pdsch_AggregationFactor_r16;
...
typedef struct SPS_Config {
	...
	struct SPS_Config__ext2 {
		long	*sps_HARQ_Deferral_r17;	/* OPTIONAL */
		PUCCH_ResourceId_t	*n1PUCCH_AN_PUCCHsSCell_r17;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_pdsch_AggregationFactor_r16_29;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_SPS_Config;
extern asn_SEQUENCE_specifics_t asn_SPC_SPS_Config_specs_1;
extern asn_TYPE_member_t asn_MBR_SPS_Config_1[6];
