...
typedef enum PDCP_Config__ext3__survivalTimeStateSupport_r17 {
	PDCP_Config__ext3__survivalTimeStateSupport_r17_true	= 0
} e_PDCP_Config__ext3__survivalTimeStateSupport_r17;

/* Forward declarations */
struct SetupRelease_DiscardTimerExt_r16;
struct SetupRelease_EthernetHeaderCompression_r16;
struct SetupRelease_UplinkDataCompression_r17;
struct SetupRelease_DiscardTimerExt2_r17;
...
typedef struct PDCP_Config {
	...
	struct PDCP_Config__ext2 {
		struct SetupRelease_DiscardTimerExt_r16	*discardTimerExt_r16;	/* OPTIONAL */
		struct PDCP_Config__ext2__moreThanTwoRLC_DRB_r16 {
			LogicalChannelIdentity_t	*splitSecondaryPath_r16;	/* OPTIONAL */
			struct PDCP_Config__ext2__moreThanTwoRLC_DRB_r16__duplicationState_r16 {
		...
		struct SetupRelease_EthernetHeaderCompression_r16	*ethernetHeaderCompression_r16;	/* OPTIONAL */
	...
	struct PDCP_Config__ext3 {
		...
		struct SetupRelease_UplinkDataCompression_r17	*uplinkDataCompression_r17;	/* OPTIONAL */
		struct SetupRelease_DiscardTimerExt2_r17	*discardTimerExt2_r17;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_survivalTimeStateSupport_r17_138;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_PDCP_Config;
extern asn_SEQUENCE_specifics_t asn_SPC_PDCP_Config_specs_1;
extern asn_TYPE_member_t asn_MBR_PDCP_Config_1[6];
