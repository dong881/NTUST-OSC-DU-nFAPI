...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_extendedT_PollRetransmit_r16_constr_10 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_extendedT_StatusProhibit_r16_constr_12 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_am_WithLongSN_RedCap_r17_constr_15 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_extendedT_PollRetransmit_r16_value2enum_10[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_extendedT_PollRetransmit_r16_enum2value_10[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_extendedT_PollRetransmit_r16_specs_10 = {
	asn_MAP_extendedT_PollRetransmit_r16_value2enum_10,	/* "tag" => N; sorted by tag */
	asn_MAP_extendedT_PollRetransmit_r16_enum2value_10,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_extendedT_PollRetransmit_r16_tags_10[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_extendedT_PollRetransmit_r16_10 = {
	"extendedT-PollRetransmit-r16",
	"extendedT-PollRetransmit-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_extendedT_PollRetransmit_r16_tags_10,
	sizeof(asn_DEF_extendedT_PollRetransmit_r16_tags_10)
		/sizeof(asn_DEF_extendedT_PollRetransmit_r16_tags_10[0]) - 1, /* 1 */
	asn_DEF_extendedT_PollRetransmit_r16_tags_10,	/* Same as above */
	sizeof(asn_DEF_extendedT_PollRetransmit_r16_tags_10)
		/sizeof(asn_DEF_extendedT_PollRetransmit_r16_tags_10[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_extendedT_PollRetransmit_r16_constr_10,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_extendedT_PollRetransmit_r16_specs_10	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_extendedT_StatusProhibit_r16_value2enum_12[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_extendedT_StatusProhibit_r16_enum2value_12[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_extendedT_StatusProhibit_r16_specs_12 = {
	asn_MAP_extendedT_StatusProhibit_r16_value2enum_12,	/* "tag" => N; sorted by tag */
	asn_MAP_extendedT_StatusProhibit_r16_enum2value_12,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_extendedT_StatusProhibit_r16_tags_12[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_extendedT_StatusProhibit_r16_12 = {
	"extendedT-StatusProhibit-r16",
	"extendedT-StatusProhibit-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_extendedT_StatusProhibit_r16_tags_12,
	sizeof(asn_DEF_extendedT_StatusProhibit_r16_tags_12)
		/sizeof(asn_DEF_extendedT_StatusProhibit_r16_tags_12[0]) - 1, /* 1 */
	asn_DEF_extendedT_StatusProhibit_r16_tags_12,	/* Same as above */
	sizeof(asn_DEF_extendedT_StatusProhibit_r16_tags_12)
		/sizeof(asn_DEF_extendedT_StatusProhibit_r16_tags_12[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_extendedT_StatusProhibit_r16_constr_12,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_extendedT_StatusProhibit_r16_specs_12	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_9[] = {
	{ ATF_POINTER, 2, offsetof(struct RLC_Parameters__ext1, extendedT_PollRetransmit_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_extendedT_PollRetransmit_r16_10,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct RLC_Parameters__ext1, extendedT_StatusProhibit_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_extendedT_StatusProhibit_r16_12,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_9 = {
	sizeof(struct RLC_Parameters__ext1),
	offsetof(struct RLC_Parameters__ext1, _asn_ctx),
...
static const asn_INTEGER_enum_map_t asn_MAP_am_WithLongSN_RedCap_r17_value2enum_15[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_am_WithLongSN_RedCap_r17_enum2value_15[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_am_WithLongSN_RedCap_r17_specs_15 = {
	asn_MAP_am_WithLongSN_RedCap_r17_value2enum_15,	/* "tag" => N; sorted by tag */
	asn_MAP_am_WithLongSN_RedCap_r17_enum2value_15,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_am_WithLongSN_RedCap_r17_tags_15[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_am_WithLongSN_RedCap_r17_15 = {
	"am-WithLongSN-RedCap-r17",
	"am-WithLongSN-RedCap-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_am_WithLongSN_RedCap_r17_tags_15,
	sizeof(asn_DEF_am_WithLongSN_RedCap_r17_tags_15)
		/sizeof(asn_DEF_am_WithLongSN_RedCap_r17_tags_15[0]) - 1, /* 1 */
	asn_DEF_am_WithLongSN_RedCap_r17_tags_15,	/* Same as above */
	sizeof(asn_DEF_am_WithLongSN_RedCap_r17_tags_15)
		/sizeof(asn_DEF_am_WithLongSN_RedCap_r17_tags_15[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_am_WithLongSN_RedCap_r17_constr_15,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_am_WithLongSN_RedCap_r17_specs_15	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_14[] = {
	{ ATF_POINTER, 1, offsetof(struct RLC_Parameters__ext2, am_WithLongSN_RedCap_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_am_WithLongSN_RedCap_r17_15,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_14 = {
	sizeof(struct RLC_Parameters__ext2),
	offsetof(struct RLC_Parameters__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RLC_Parameters_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RLC_Parameters, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RLC_Parameters, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_14,
		0,
