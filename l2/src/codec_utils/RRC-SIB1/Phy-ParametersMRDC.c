...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_tdd_PCellUL_TX_AllUL_Subframe_r16_constr_8 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_fdd_PCellUL_TX_AllUL_Subframe_r16_constr_10 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct Phy_ParametersMRDC__ext1, spCellPlacement),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_5 = {
	sizeof(struct Phy_ParametersMRDC__ext1),
	offsetof(struct Phy_ParametersMRDC__ext1, _asn_ctx),
...
static const asn_INTEGER_enum_map_t asn_MAP_tdd_PCellUL_TX_AllUL_Subframe_r16_value2enum_8[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_tdd_PCellUL_TX_AllUL_Subframe_r16_enum2value_8[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_tdd_PCellUL_TX_AllUL_Subframe_r16_specs_8 = {
	asn_MAP_tdd_PCellUL_TX_AllUL_Subframe_r16_value2enum_8,	/* "tag" => N; sorted by tag */
	asn_MAP_tdd_PCellUL_TX_AllUL_Subframe_r16_enum2value_8,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_tdd_PCellUL_TX_AllUL_Subframe_r16_tags_8[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_tdd_PCellUL_TX_AllUL_Subframe_r16_8 = {
	"tdd-PCellUL-TX-AllUL-Subframe-r16",
	"tdd-PCellUL-TX-AllUL-Subframe-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_tdd_PCellUL_TX_AllUL_Subframe_r16_tags_8,
	sizeof(asn_DEF_tdd_PCellUL_TX_AllUL_Subframe_r16_tags_8)
		/sizeof(asn_DEF_tdd_PCellUL_TX_AllUL_Subframe_r16_tags_8[0]) - 1, /* 1 */
	asn_DEF_tdd_PCellUL_TX_AllUL_Subframe_r16_tags_8,	/* Same as above */
	sizeof(asn_DEF_tdd_PCellUL_TX_AllUL_Subframe_r16_tags_8)
		/sizeof(asn_DEF_tdd_PCellUL_TX_AllUL_Subframe_r16_tags_8[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_tdd_PCellUL_TX_AllUL_Subframe_r16_constr_8,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	&asn_SPC_tdd_PCellUL_TX_AllUL_Subframe_r16_specs_8	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_fdd_PCellUL_TX_AllUL_Subframe_r16_value2enum_10[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_fdd_PCellUL_TX_AllUL_Subframe_r16_enum2value_10[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_fdd_PCellUL_TX_AllUL_Subframe_r16_specs_10 = {
	asn_MAP_fdd_PCellUL_TX_AllUL_Subframe_r16_value2enum_10,	/* "tag" => N; sorted by tag */
	asn_MAP_fdd_PCellUL_TX_AllUL_Subframe_r16_enum2value_10,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_fdd_PCellUL_TX_AllUL_Subframe_r16_tags_10[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_fdd_PCellUL_TX_AllUL_Subframe_r16_10 = {
	"fdd-PCellUL-TX-AllUL-Subframe-r16",
	"fdd-PCellUL-TX-AllUL-Subframe-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_fdd_PCellUL_TX_AllUL_Subframe_r16_tags_10,
	sizeof(asn_DEF_fdd_PCellUL_TX_AllUL_Subframe_r16_tags_10)
		/sizeof(asn_DEF_fdd_PCellUL_TX_AllUL_Subframe_r16_tags_10[0]) - 1, /* 1 */
	asn_DEF_fdd_PCellUL_TX_AllUL_Subframe_r16_tags_10,	/* Same as above */
	sizeof(asn_DEF_fdd_PCellUL_TX_AllUL_Subframe_r16_tags_10)
		/sizeof(asn_DEF_fdd_PCellUL_TX_AllUL_Subframe_r16_tags_10[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_fdd_PCellUL_TX_AllUL_Subframe_r16_constr_10,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_fdd_PCellUL_TX_AllUL_Subframe_r16_specs_10	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_7[] = {
	{ ATF_POINTER, 2, offsetof(struct Phy_ParametersMRDC__ext2, tdd_PCellUL_TX_AllUL_Subframe_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_tdd_PCellUL_TX_AllUL_Subframe_r16_8,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct Phy_ParametersMRDC__ext2, fdd_PCellUL_TX_AllUL_Subframe_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_fdd_PCellUL_TX_AllUL_Subframe_r16_10,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext2_oms_7[] = { 0, 1 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_7 = {
	sizeof(struct Phy_ParametersMRDC__ext2),
	offsetof(struct Phy_ParametersMRDC__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_Phy_ParametersMRDC_1[] = {
	{ ATF_POINTER, 3, offsetof(struct Phy_ParametersMRDC, naics_Capability_List),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct Phy_ParametersMRDC, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct Phy_ParametersMRDC, ext2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext2_7,
		0,
...
static const int asn_MAP_Phy_ParametersMRDC_oms_1[] = { 0, 1, 2 };
