...
typedef enum MeasAndMobParametersXDD_Diff__ext2__sftd_MeasNR_Neigh {
	MeasAndMobParametersXDD_Diff__ext2__sftd_MeasNR_Neigh_supported	= 0
} e_MeasAndMobParametersXDD_Diff__ext2__sftd_MeasNR_Neigh;
typedef enum MeasAndMobParametersXDD_Diff__ext2__sftd_MeasNR_Neigh_DRX {
	MeasAndMobParametersXDD_Diff__ext2__sftd_MeasNR_Neigh_DRX_supported	= 0
} e_MeasAndMobParametersXDD_Diff__ext2__sftd_MeasNR_Neigh_DRX;
typedef enum MeasAndMobParametersXDD_Diff__ext3__dummy {
	MeasAndMobParametersXDD_Diff__ext3__dummy_supported	= 0
} e_MeasAndMobParametersXDD_Diff__ext3__dummy;
...
typedef struct MeasAndMobParametersXDD_Diff {
	...
	struct MeasAndMobParametersXDD_Diff__ext2 {
	...
	struct MeasAndMobParametersXDD_Diff__ext3 {
		long	*dummy;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_sftd_MeasNR_Neigh_15;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_sftd_MeasNR_Neigh_DRX_17;	// (Use -fall-defs-global to expose) */
