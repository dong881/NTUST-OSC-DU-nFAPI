...
static asn_TYPE_member_t asn_MBR_ext1_4[] = {
	{ ATF_POINTER, 1, offsetof(struct InterRAT_Parameters__ext1, utra_FDD_r16),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_4 = {
	sizeof(struct InterRAT_Parameters__ext1),
	offsetof(struct InterRAT_Parameters__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_InterRAT_Parameters_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct InterRAT_Parameters, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_4,
		0,
