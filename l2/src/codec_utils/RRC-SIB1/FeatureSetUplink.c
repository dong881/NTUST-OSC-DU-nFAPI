...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_dummy3_constr_8 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_dummy3_value2enum_8[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_dummy3_enum2value_8[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_dummy3_specs_8 = {
	asn_MAP_dummy3_value2enum_8,	/* "tag" => N; sorted by tag */
	asn_MAP_dummy3_enum2value_8,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_dummy3_tags_8[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_dummy3_8 = {
	"dummy3",
	"dummy3",
	&asn_OP_NativeEnumerated,
	asn_DEF_dummy3_tags_8,
	sizeof(asn_DEF_dummy3_tags_8)
		/sizeof(asn_DEF_dummy3_tags_8[0]) - 1, /* 1 */
	asn_DEF_dummy3_tags_8,	/* Same as above */
	sizeof(asn_DEF_dummy3_tags_8)
		/sizeof(asn_DEF_dummy3_tags_8[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_dummy3_constr_8,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_dummy3_specs_8	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_FeatureSetUplink_1[] = {
	...
	{ ATF_POINTER, 10, offsetof(struct FeatureSetUplink, dummy3),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dummy3_8,
		0,
