...
static int
memb_servingAdditionalPCIList_r17_constraint_6(const asn_TYPE_descriptor_t *td, const void *sptr,
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_servingAdditionalPCIList_r17_constr_7 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_servingAdditionalPCIList_r17_constr_7 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_servingAdditionalPCIList_r17_7[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (2 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_servingAdditionalPCIList_r17_tags_7[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_servingAdditionalPCIList_r17_specs_7 = {
	sizeof(struct CSI_SSB_ResourceSet__ext1__servingAdditionalPCIList_r17),
	offsetof(struct CSI_SSB_ResourceSet__ext1__servingAdditionalPCIList_r17, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_servingAdditionalPCIList_r17_7 = {
	"servingAdditionalPCIList-r17",
	"servingAdditionalPCIList-r17",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_servingAdditionalPCIList_r17_tags_7,
	sizeof(asn_DEF_servingAdditionalPCIList_r17_tags_7)
		/sizeof(asn_DEF_servingAdditionalPCIList_r17_tags_7[0]) - 1, /* 1 */
	asn_DEF_servingAdditionalPCIList_r17_tags_7,	/* Same as above */
	sizeof(asn_DEF_servingAdditionalPCIList_r17_tags_7)
		/sizeof(asn_DEF_servingAdditionalPCIList_r17_tags_7[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_servingAdditionalPCIList_r17_constr_7,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	asn_MBR_servingAdditionalPCIList_r17_7,
	1,	/* Single element */
	&asn_SPC_servingAdditionalPCIList_r17_specs_7	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_6[] = {
	{ ATF_POINTER, 1, offsetof(struct CSI_SSB_ResourceSet__ext1, servingAdditionalPCIList_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_servingAdditionalPCIList_r17_7,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_servingAdditionalPCIList_r17_constr_7,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_servingAdditionalPCIList_r17_constraint_6
		},
		0, 0, /* No default value */
		"servingAdditionalPCIList-r17"
		},
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_6 = {
	sizeof(struct CSI_SSB_ResourceSet__ext1),
	offsetof(struct CSI_SSB_ResourceSet__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_CSI_SSB_ResourceSet_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CSI_SSB_ResourceSet, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_6,
		0,
...
static const int asn_MAP_CSI_SSB_ResourceSet_oms_1[] = { 2 };
...
asn_SEQUENCE_specifics_t asn_SPC_CSI_SSB_ResourceSet_specs_1 = {
	...
	asn_MAP_CSI_SSB_ResourceSet_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */
