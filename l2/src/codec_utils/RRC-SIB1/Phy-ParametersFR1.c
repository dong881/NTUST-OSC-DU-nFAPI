...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_pdcch_MonitoringSingleSpanFirst4Sym_r16_constr_31 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_pdcch_MonitoringSingleOccasion_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_pdsch_RE_MappingFR1_PerSlot_constr_13,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static const asn_INTEGER_enum_map_t asn_MAP_pdcch_MonitoringSingleSpanFirst4Sym_r16_value2enum_31[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_pdcch_MonitoringSingleSpanFirst4Sym_r16_enum2value_31[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_pdcch_MonitoringSingleSpanFirst4Sym_r16_specs_31 = {
	asn_MAP_pdcch_MonitoringSingleSpanFirst4Sym_r16_value2enum_31,	/* "tag" => N; sorted by tag */
	asn_MAP_pdcch_MonitoringSingleSpanFirst4Sym_r16_enum2value_31,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_pdcch_MonitoringSingleSpanFirst4Sym_r16_tags_31[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_pdcch_MonitoringSingleSpanFirst4Sym_r16_31 = {
	"pdcch-MonitoringSingleSpanFirst4Sym-r16",
	"pdcch-MonitoringSingleSpanFirst4Sym-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_pdcch_MonitoringSingleSpanFirst4Sym_r16_tags_31,
	sizeof(asn_DEF_pdcch_MonitoringSingleSpanFirst4Sym_r16_tags_31)
		/sizeof(asn_DEF_pdcch_MonitoringSingleSpanFirst4Sym_r16_tags_31[0]) - 1, /* 1 */
	asn_DEF_pdcch_MonitoringSingleSpanFirst4Sym_r16_tags_31,	/* Same as above */
	sizeof(asn_DEF_pdcch_MonitoringSingleSpanFirst4Sym_r16_tags_31)
		/sizeof(asn_DEF_pdcch_MonitoringSingleSpanFirst4Sym_r16_tags_31[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_pdcch_MonitoringSingleSpanFirst4Sym_r16_constr_31,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_pdcch_MonitoringSingleSpanFirst4Sym_r16_specs_31	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_30[] = {
	{ ATF_POINTER, 1, offsetof(struct Phy_ParametersFR1__ext2, pdcch_MonitoringSingleSpanFirst4Sym_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_pdcch_MonitoringSingleSpanFirst4Sym_r16_31,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_30 = {
	sizeof(struct Phy_ParametersFR1__ext2),
	offsetof(struct Phy_ParametersFR1__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_Phy_ParametersFR1_1[] = {
	{ ATF_POINTER, 6, offsetof(struct Phy_ParametersFR1, pdcch_MonitoringSingleOccasion),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct Phy_ParametersFR1, scs_60kHz),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_scs_60kHz_4,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct Phy_ParametersFR1, pdsch_256QAM_FR1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct Phy_ParametersFR1, pdsch_RE_MappingFR1_PerSymbol),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct Phy_ParametersFR1, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_12,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct Phy_ParametersFR1, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_30,
		0,
...
static const int asn_MAP_Phy_ParametersFR1_oms_1[] = { 0, 1, 2, 3, 4, 5 };
