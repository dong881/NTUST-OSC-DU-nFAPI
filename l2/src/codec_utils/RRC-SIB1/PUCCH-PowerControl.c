...
static asn_TYPE_member_t asn_MBR_ext1_14[] = {
	{ ATF_POINTER, 1, offsetof(struct PUCCH_PowerControl__ext1, pathlossReferenceRSs_v1610),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_PathlossReferenceRSs_v1610,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_14 = {
	sizeof(struct PUCCH_PowerControl__ext1),
	offsetof(struct PUCCH_PowerControl__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PUCCH_PowerControl_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PUCCH_PowerControl, ext1),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext1_14,
		0,
