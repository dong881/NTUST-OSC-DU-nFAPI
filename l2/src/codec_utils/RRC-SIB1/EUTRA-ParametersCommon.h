...
typedef enum EUTRA_ParametersCommon__ext2__nr_HO_ToEN_DC_r16 {
	EUTRA_ParametersCommon__ext2__nr_HO_ToEN_DC_r16_supported	= 0
} e_EUTRA_ParametersCommon__ext2__nr_HO_ToEN_DC_r16;
...
typedef struct EUTRA_ParametersCommon {
	...
	struct EUTRA_ParametersCommon__ext2 {
...
/* extern asn_TYPE_descriptor_t asn_DEF_nr_HO_ToEN_DC_r16_14;	// (Use -fall-defs-global to expose) */
