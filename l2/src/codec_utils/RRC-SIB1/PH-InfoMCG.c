...
static asn_TYPE_member_t asn_MBR_ext1_6[] = {
	{ ATF_POINTER, 1, offsetof(struct PH_InfoMCG__ext1, twoSRS_PUSCH_Repetition_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_6 = {
	sizeof(struct PH_InfoMCG__ext1),
	offsetof(struct PH_InfoMCG__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PH_InfoMCG_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct PH_InfoMCG, ph_SupplementaryUplink),
	...
	{ ATF_POINTER, 1, offsetof(struct PH_InfoMCG, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_6,
		0,
...
static const int asn_MAP_PH_InfoMCG_oms_1[] = { 2, 3 };
