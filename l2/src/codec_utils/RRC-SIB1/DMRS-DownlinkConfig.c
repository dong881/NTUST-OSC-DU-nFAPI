...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_dmrs_Downlink_r16_constr_15 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_dmrs_Downlink_r16_value2enum_15[] = {
	{ 0,	7,	"enabled" }
};
static const unsigned int asn_MAP_dmrs_Downlink_r16_enum2value_15[] = {
	0	/* enabled(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_dmrs_Downlink_r16_specs_15 = {
	asn_MAP_dmrs_Downlink_r16_value2enum_15,	/* "tag" => N; sorted by tag */
	asn_MAP_dmrs_Downlink_r16_enum2value_15,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_dmrs_Downlink_r16_tags_15[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_dmrs_Downlink_r16_15 = {
	"dmrs-Downlink-r16",
	"dmrs-Downlink-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_dmrs_Downlink_r16_tags_15,
	sizeof(asn_DEF_dmrs_Downlink_r16_tags_15)
		/sizeof(asn_DEF_dmrs_Downlink_r16_tags_15[0]) - 1, /* 1 */
	asn_DEF_dmrs_Downlink_r16_tags_15,	/* Same as above */
	sizeof(asn_DEF_dmrs_Downlink_r16_tags_15)
		/sizeof(asn_DEF_dmrs_Downlink_r16_tags_15[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_dmrs_Downlink_r16_constr_15,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_dmrs_Downlink_r16_specs_15	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_14[] = {
	{ ATF_POINTER, 1, offsetof(struct DMRS_DownlinkConfig__ext1, dmrs_Downlink_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dmrs_Downlink_r16_15,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_14 = {
	sizeof(struct DMRS_DownlinkConfig__ext1),
	offsetof(struct DMRS_DownlinkConfig__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_DMRS_DownlinkConfig_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct DMRS_DownlinkConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_14,
		0,
