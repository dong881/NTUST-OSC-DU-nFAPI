...
static asn_TYPE_member_t asn_MBR_ext1_6[] = {
	{ ATF_POINTER, 3, offsetof(struct SSB_ConfigMobility__ext1, ssb_PositionQCL_Common_r16),
	...
	{ ATF_POINTER, 2, offsetof(struct SSB_ConfigMobility__ext1, ssb_PositionQCL_CellsToAddModList_r16),
	...
	{ ATF_POINTER, 1, offsetof(struct SSB_ConfigMobility__ext1, ssb_PositionQCL_CellsToRemoveList_r16),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_6 = {
	sizeof(struct SSB_ConfigMobility__ext1),
	offsetof(struct SSB_ConfigMobility__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext2_10[] = {
	{ ATF_POINTER, 3, offsetof(struct SSB_ConfigMobility__ext2, deriveSSB_IndexFromCellInter_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SSB_ConfigMobility__ext2, ssb_PositionQCL_Common_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SSB_ConfigMobility__ext2, ssb_PositionQCL_Cells_r17),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_SSB_PositionQCL_CellList_r17,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext2_oms_10[] = { 0, 1, 2 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_10 = {
	sizeof(struct SSB_ConfigMobility__ext2),
	offsetof(struct SSB_ConfigMobility__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext3_14[] = {
	{ ATF_POINTER, 2, offsetof(struct SSB_ConfigMobility__ext3, cca_CellsToAddModList_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PCI_List,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SSB_ConfigMobility__ext3, cca_CellsToRemoveList_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PCI_List,
		0,
...
static const int asn_MAP_ext3_oms_14[] = { 0, 1 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_14 = {
	sizeof(struct SSB_ConfigMobility__ext3),
	offsetof(struct SSB_ConfigMobility__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SSB_ConfigMobility_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct SSB_ConfigMobility, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_6,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SSB_ConfigMobility, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_10,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SSB_ConfigMobility, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext3_14,
		0,
