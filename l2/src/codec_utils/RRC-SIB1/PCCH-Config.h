...
typedef enum PCCH_Config__firstPDCCH_MonitoringOccasionOfPO_PR {
	...
	PCCH_Config__firstPDCCH_MonitoringOccasionOfPO_PR_sCS480KHZoneT_SCS120KHZquarterT_SCS60KHZoneEighthT_SCS30KHZoneSixteenthT,
	PCCH_Config__firstPDCCH_MonitoringOccasionOfPO_PR_sCS480KHZhalfT_SCS120KHZoneEighthT_SCS60KHZoneSixteenthT,
	PCCH_Config__firstPDCCH_MonitoringOccasionOfPO_PR_sCS480KHZquarterT_SCS120KHZoneSixteenthT
} PCCH_Config__firstPDCCH_MonitoringOccasionOfPO_PR;
typedef enum PCCH_Config__ext2__ranPagingInIdlePO_r17 {
	PCCH_Config__ext2__ranPagingInIdlePO_r17_true	= 0
} e_PCCH_Config__ext2__ranPagingInIdlePO_r17;
typedef enum PCCH_Config__ext2__firstPDCCH_MonitoringOccasionOfPO_v1710_PR {
	PCCH_Config__ext2__firstPDCCH_MonitoringOccasionOfPO_v1710_PR_NOTHING,	/* No components present */
	PCCH_Config__ext2__firstPDCCH_MonitoringOccasionOfPO_v1710_PR_sCS480KHZoneEighthT,
	PCCH_Config__ext2__firstPDCCH_MonitoringOccasionOfPO_v1710_PR_sCS480KHZoneSixteenthT
} PCCH_Config__ext2__firstPDCCH_MonitoringOccasionOfPO_v1710_PR;
...
typedef struct PCCH_Config {
	...
	struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO {
		...
		union PCCH_Config__firstPDCCH_MonitoringOccasionOfPO_u {
			...
			struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO__sCS480KHZoneT_SCS120KHZquarterT_SCS60KHZoneEighthT_SCS30KHZoneSixteenthT {
				A_SEQUENCE_OF(long) list;
				
				/* Context for parsing across buffer boundaries */
				asn_struct_ctx_t _asn_ctx;
			} *sCS480KHZoneT_SCS120KHZquarterT_SCS60KHZoneEighthT_SCS30KHZoneSixteenthT;
			struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO__sCS480KHZhalfT_SCS120KHZoneEighthT_SCS60KHZoneSixteenthT {
				A_SEQUENCE_OF(long) list;
				
				/* Context for parsing across buffer boundaries */
				asn_struct_ctx_t _asn_ctx;
			} *sCS480KHZhalfT_SCS120KHZoneEighthT_SCS60KHZoneSixteenthT;
			struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO__sCS480KHZquarterT_SCS120KHZoneSixteenthT {
				A_SEQUENCE_OF(long) list;
	 ...
	 */
	struct PCCH_Config__ext1 {
		long	*nrofPDCCH_MonitoringOccasionPerSSB_InPO_r16;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext1;
	struct PCCH_Config__ext2 {
		long	*ranPagingInIdlePO_r17;	/* OPTIONAL */
		struct PCCH_Config__ext2__firstPDCCH_MonitoringOccasionOfPO_v1710 {
			PCCH_Config__ext2__firstPDCCH_MonitoringOccasionOfPO_v1710_PR present;
			union PCCH_Config__ext2__firstPDCCH_MonitoringOccasionOfPO_v1710_u {
				struct PCCH_Config__ext2__firstPDCCH_MonitoringOccasionOfPO_v1710__sCS480KHZoneEighthT {
					A_SEQUENCE_OF(long) list;
					
					/* Context for parsing across buffer boundaries */
					asn_struct_ctx_t _asn_ctx;
				} *sCS480KHZoneEighthT;
				struct PCCH_Config__ext2__firstPDCCH_MonitoringOccasionOfPO_v1710__sCS480KHZoneSixteenthT {
					A_SEQUENCE_OF(long) list;
...
/* extern asn_TYPE_descriptor_t asn_DEF_ranPagingInIdlePO_r17_34;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_PCCH_Config;
extern asn_SEQUENCE_specifics_t asn_SPC_PCCH_Config_specs_1;
extern asn_TYPE_member_t asn_MBR_PCCH_Config_1[6];
