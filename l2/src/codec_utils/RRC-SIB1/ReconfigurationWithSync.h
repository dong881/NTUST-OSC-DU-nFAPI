...
struct SL_PathSwitchConfig_r17;
...
typedef struct ReconfigurationWithSync {
	...
	struct ReconfigurationWithSync__ext2 {
		struct DAPS_UplinkPowerConfig_r16	*daps_UplinkPowerConfig_r16;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext2;
	struct ReconfigurationWithSync__ext3 {
		struct SL_PathSwitchConfig_r17	*sl_PathSwitchConfig_r17;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_ReconfigurationWithSync_1[7];
