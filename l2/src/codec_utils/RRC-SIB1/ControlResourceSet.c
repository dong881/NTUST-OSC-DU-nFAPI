 ...
 */
static int
memb_rb_Offset_r16_constraint_28(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_tci_PresentDCI_1_2_r16_constraint_28(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_coresetPoolIndex_r16_constraint_28(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_rb_Offset_r16_constr_29 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_tci_PresentDCI_1_2_r16_constr_30 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_coresetPoolIndex_r16_constr_31 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_followUnifiedTCI_State_r17_constr_34 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_ext1_28[] = {
	{ ATF_POINTER, 4, offsetof(struct ControlResourceSet__ext1, rb_Offset_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_rb_Offset_r16_constr_29,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_rb_Offset_r16_constraint_28
		},
		0, 0, /* No default value */
		"rb-Offset-r16"
		},
	{ ATF_POINTER, 3, offsetof(struct ControlResourceSet__ext1, tci_PresentDCI_1_2_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_tci_PresentDCI_1_2_r16_constr_30,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_tci_PresentDCI_1_2_r16_constraint_28
		},
		0, 0, /* No default value */
		"tci-PresentDCI-1-2-r16"
		},
	{ ATF_POINTER, 2, offsetof(struct ControlResourceSet__ext1, coresetPoolIndex_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_coresetPoolIndex_r16_constr_31,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_coresetPoolIndex_r16_constraint_28
		},
		0, 0, /* No default value */
		"coresetPoolIndex-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct ControlResourceSet__ext1, controlResourceSetId_v1610),
...
static const int asn_MAP_ext1_oms_28[] = { 0, 1, 2, 3 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_28 = {
	sizeof(struct ControlResourceSet__ext1),
	offsetof(struct ControlResourceSet__ext1, _asn_ctx),
...
static const asn_INTEGER_enum_map_t asn_MAP_followUnifiedTCI_State_r17_value2enum_34[] = {
	{ 0,	7,	"enabled" }
};
static const unsigned int asn_MAP_followUnifiedTCI_State_r17_enum2value_34[] = {
	0	/* enabled(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_followUnifiedTCI_State_r17_specs_34 = {
	asn_MAP_followUnifiedTCI_State_r17_value2enum_34,	/* "tag" => N; sorted by tag */
	asn_MAP_followUnifiedTCI_State_r17_enum2value_34,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_followUnifiedTCI_State_r17_tags_34[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_followUnifiedTCI_State_r17_34 = {
	"followUnifiedTCI-State-r17",
	"followUnifiedTCI-State-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_followUnifiedTCI_State_r17_tags_34,
	sizeof(asn_DEF_followUnifiedTCI_State_r17_tags_34)
		/sizeof(asn_DEF_followUnifiedTCI_State_r17_tags_34[0]) - 1, /* 1 */
	asn_DEF_followUnifiedTCI_State_r17_tags_34,	/* Same as above */
	sizeof(asn_DEF_followUnifiedTCI_State_r17_tags_34)
		/sizeof(asn_DEF_followUnifiedTCI_State_r17_tags_34[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_followUnifiedTCI_State_r17_constr_34,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_followUnifiedTCI_State_r17_specs_34	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_33[] = {
	{ ATF_POINTER, 1, offsetof(struct ControlResourceSet__ext2, followUnifiedTCI_State_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_followUnifiedTCI_State_r17_34,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext2_oms_33[] = { 0 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_33 = {
	sizeof(struct ControlResourceSet__ext2),
	offsetof(struct ControlResourceSet__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_ControlResourceSet_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct ControlResourceSet, tci_StatesPDCCH_ToAddList),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct ControlResourceSet, tci_StatesPDCCH_ToReleaseList),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct ControlResourceSet, tci_PresentInDCI),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct ControlResourceSet, pdcch_DMRS_ScramblingID),
	...
	{ ATF_POINTER, 2, offsetof(struct ControlResourceSet, ext1),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext1_28,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct ControlResourceSet, ext2),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext2_33,
		0,
...
static const int asn_MAP_ControlResourceSet_oms_1[] = { 5, 6, 7, 8, 9, 10 };
