...
static int
memb_msgA_PUSCH_Resource_Index_r16_constraint_5(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_msgA_PUSCH_Resource_Index_r16_constr_6 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct CFRA_SSB_Resource__ext1, msgA_PUSCH_Resource_Index_r16),
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_msgA_PUSCH_Resource_Index_r16_constr_6,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_msgA_PUSCH_Resource_Index_r16_constraint_5
		},
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_5 = {
	sizeof(struct CFRA_SSB_Resource__ext1),
	offsetof(struct CFRA_SSB_Resource__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_CFRA_SSB_Resource_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CFRA_SSB_Resource, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
