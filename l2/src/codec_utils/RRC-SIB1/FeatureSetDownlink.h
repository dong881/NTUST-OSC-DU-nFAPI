...
typedef enum FeatureSetDownlink__dummy8 {
	FeatureSetDownlink__dummy8_supported	= 0
} e_FeatureSetDownlink__dummy8;
...
/* extern asn_TYPE_descriptor_t asn_DEF_dummy8_9;	// (Use -fall-defs-global to expose) */
