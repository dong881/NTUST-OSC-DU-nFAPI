...
static asn_TYPE_member_t asn_MBR_measResultNeighCells_4[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct MeasResults__measResultNeighCells, choice.measResultListUTRA_FDD_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResults__measResultNeighCells, choice.sl_MeasResultsCandRelay_r17),
...
static asn_TYPE_member_t asn_MBR_ext2_16[] = {
	{ ATF_POINTER, 1, offsetof(struct MeasResults__ext2, measResultCellListSFTD_NR),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_ext3_18[] = {
	{ ATF_POINTER, 5, offsetof(struct MeasResults__ext3, measResultForRSSI_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct MeasResults__ext3, locationInfo_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct MeasResults__ext3, ul_PDCP_DelayValueResultList_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct MeasResults__ext3, measResultsSL_r16),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResults__ext3, measResultCLI_r16),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_ext4_24[] = {
	{ ATF_POINTER, 4, offsetof(struct MeasResults__ext4, measResultRxTxTimeDiff_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct MeasResults__ext4, sl_MeasResultServingRelay_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct MeasResults__ext4, ul_PDCP_ExcessDelayResultList_r17),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResults__ext4, coarseLocationInfo_r17),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
...
static const int asn_MAP_ext4_oms_24[] = { 0, 1, 2, 3 };
...
asn_TYPE_member_t asn_MBR_MeasResults_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct MeasResults, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_11,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct MeasResults, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_16,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct MeasResults, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext3_18,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResults, ext4),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext4_24,
		0,
