...
struct UEInformationRequest_r16;
struct DLInformationTransferMRDC_r16;
struct LoggedMeasurementConfiguration_r16;
	...
	union DL_DCCH_MessageType_u {
		struct DL_DCCH_MessageType__c1 {
			...
			union DL_DCCH_MessageType__c1_u {
				...
				struct UEInformationRequest_r16	*ueInformationRequest_r16;
				struct DLInformationTransferMRDC_r16	*dlInformationTransferMRDC_r16;
				struct LoggedMeasurementConfiguration_r16	*loggedMeasurementConfiguration_r16;
				NULL_t	 spare3;
				NULL_t	 spare2;
				NULL_t	 spare1;
			} choice;
