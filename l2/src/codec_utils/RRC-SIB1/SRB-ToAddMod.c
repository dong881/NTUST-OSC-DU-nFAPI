...
static asn_TYPE_member_t asn_MBR_ext1_9[] = {
	{ ATF_POINTER, 1, offsetof(struct SRB_ToAddMod__ext1, srb_Identity_v1700),
...
asn_TYPE_member_t asn_MBR_SRB_ToAddMod_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct SRB_ToAddMod, reestablishPDCP),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct SRB_ToAddMod, discardOnPDCP),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SRB_ToAddMod, pdcp_Config),
	...
	{ ATF_POINTER, 1, offsetof(struct SRB_ToAddMod, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
