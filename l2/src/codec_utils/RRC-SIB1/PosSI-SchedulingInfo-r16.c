...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_posSchedulingInfoList_r16_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
	{ ATF_POINTER, 1, offsetof(struct PosSI_SchedulingInfo_r16__ext1, posSI_RequestConfigRedCap_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_7 = {
	sizeof(struct PosSI_SchedulingInfo_r16__ext1),
	offsetof(struct PosSI_SchedulingInfo_r16__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PosSI_SchedulingInfo_r16_1[] = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_posSchedulingInfoList_r16_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_posSchedulingInfoList_r16_constraint_1
		},
		0, 0, /* No default value */
		"posSchedulingInfoList-r16"
		},
	{ ATF_POINTER, 3, offsetof(struct PosSI_SchedulingInfo_r16, posSI_RequestConfig_r16),
	...
	{ ATF_POINTER, 2, offsetof(struct PosSI_SchedulingInfo_r16, posSI_RequestConfigSUL_r16),
	...
	{ ATF_POINTER, 1, offsetof(struct PosSI_SchedulingInfo_r16, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
...
static const int asn_MAP_PosSI_SchedulingInfo_r16_oms_1[] = { 1, 2, 3 };
