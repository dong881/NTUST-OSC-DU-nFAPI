...
typedef enum DRB_ToAddMod__ext1__daps_Config_r16 {
	DRB_ToAddMod__ext1__daps_Config_r16_true	= 0
} e_DRB_ToAddMod__ext1__daps_Config_r16;
...
/* extern asn_TYPE_descriptor_t asn_DEF_daps_Config_r16_13;	// (Use -fall-defs-global to expose) */
