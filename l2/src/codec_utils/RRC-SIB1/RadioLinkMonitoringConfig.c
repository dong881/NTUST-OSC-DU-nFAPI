...
static asn_TYPE_member_t asn_MBR_ext1_25[] = {
	{ ATF_POINTER, 1, offsetof(struct RadioLinkMonitoringConfig__ext1, beamfailure_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_25 = {
	sizeof(struct RadioLinkMonitoringConfig__ext1),
	offsetof(struct RadioLinkMonitoringConfig__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RadioLinkMonitoringConfig_1[] = {
	{ ATF_POINTER, 5, offsetof(struct RadioLinkMonitoringConfig, failureDetectionResourcesToAddModList),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct RadioLinkMonitoringConfig, failureDetectionResourcesToReleaseList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct RadioLinkMonitoringConfig, beamFailureInstanceMaxCount),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct RadioLinkMonitoringConfig, beamFailureDetectionTimer),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct RadioLinkMonitoringConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_25,
		0,
...
static const int asn_MAP_RadioLinkMonitoringConfig_oms_1[] = { 0, 1, 2, 3, 4 };
