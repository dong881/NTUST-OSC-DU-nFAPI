...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_daps_Config_r16_constr_13 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_daps_Config_r16_value2enum_13[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_daps_Config_r16_enum2value_13[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_daps_Config_r16_specs_13 = {
	asn_MAP_daps_Config_r16_value2enum_13,	/* "tag" => N; sorted by tag */
	asn_MAP_daps_Config_r16_enum2value_13,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_daps_Config_r16_tags_13[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_daps_Config_r16_13 = {
	"daps-Config-r16",
	"daps-Config-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_daps_Config_r16_tags_13,
	sizeof(asn_DEF_daps_Config_r16_tags_13)
		/sizeof(asn_DEF_daps_Config_r16_tags_13[0]) - 1, /* 1 */
	asn_DEF_daps_Config_r16_tags_13,	/* Same as above */
	sizeof(asn_DEF_daps_Config_r16_tags_13)
		/sizeof(asn_DEF_daps_Config_r16_tags_13[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_daps_Config_r16_constr_13,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_daps_Config_r16_specs_13	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_12[] = {
	{ ATF_POINTER, 1, offsetof(struct DRB_ToAddMod__ext1, daps_Config_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_daps_Config_r16_13,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_TYPE_member_t asn_MBR_DRB_ToAddMod_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct DRB_ToAddMod, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext1_12,
		0,
