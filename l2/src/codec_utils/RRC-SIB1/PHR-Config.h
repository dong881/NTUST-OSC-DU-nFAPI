...
typedef enum PHR_Config__ext2__twoPHRMode_r17 {
	PHR_Config__ext2__twoPHRMode_r17_enabled	= 0
} e_PHR_Config__ext2__twoPHRMode_r17;

/* Forward declarations */
struct SetupRelease_MPE_Config_FR2_r16;
struct SetupRelease_MPE_Config_FR2_r17;
...
typedef struct PHR_Config {
	 ...
	 */
	struct PHR_Config__ext1 {
		struct SetupRelease_MPE_Config_FR2_r16	*mpe_Reporting_FR2_r16;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext1;
	struct PHR_Config__ext2 {
		struct SetupRelease_MPE_Config_FR2_r17	*mpe_Reporting_FR2_r17;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_twoPHRMode_r17_36;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_PHR_Config;
extern asn_SEQUENCE_specifics_t asn_SPC_PHR_Config_specs_1;
extern asn_TYPE_member_t asn_MBR_PHR_Config_1[9];
