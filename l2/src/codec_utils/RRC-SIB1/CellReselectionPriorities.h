...
struct FreqPriorityListDedicatedSlicing_r17;
...
typedef struct CellReselectionPriorities {
	 ...
	 */
	struct CellReselectionPriorities__ext1 {
		struct FreqPriorityListDedicatedSlicing_r17	*freqPriorityListDedicatedSlicing_r17;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_CellReselectionPriorities_1[4];
