...
typedef enum SearchSpace__searchSpaceType__ue_Specific__ext1__dci_Formats_MT_r16 {
	SearchSpace__searchSpaceType__ue_Specific__ext1__dci_Formats_MT_r16_formats2_5	= 0
} e_SearchSpace__searchSpaceType__ue_Specific__ext1__dci_Formats_MT_r16;
typedef enum SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsSL_r16 {
	SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsSL_r16_formats0_0_And_1_0	= 0,
	SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsSL_r16_formats0_1_And_1_1	= 1,
	SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsSL_r16_formats3_0	= 2,
	SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsSL_r16_formats3_1	= 3,
	SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsSL_r16_formats3_0_And_3_1	= 4
} e_SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsSL_r16;
typedef enum SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsExt_r16 {
	SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsExt_r16_formats0_2_And_1_2	= 0,
	SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsExt_r16_formats0_1_And_1_1And_0_2_And_1_2	= 1
} e_SearchSpace__searchSpaceType__ue_Specific__ext1__dci_FormatsExt_r16;
	...
	struct SearchSpace__searchSpaceType {
		...
		union SearchSpace__searchSpaceType_u {
			...
			struct SearchSpace__searchSpaceType__ue_Specific {
				 ...
				 * possible extensions are below.
				 */
				struct SearchSpace__searchSpaceType__ue_Specific__ext1 {
...
/* extern asn_TYPE_descriptor_t asn_DEF_dci_Formats_MT_r16_114;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_dci_FormatsSL_r16_116;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_dci_FormatsExt_r16_122;	// (Use -fall-defs-global to expose) */
