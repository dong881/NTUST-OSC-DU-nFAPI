...
static asn_TYPE_member_t asn_MBR_ext2_19[] = {
	{ ATF_POINTER, 1, offsetof(struct ReconfigurationWithSync__ext2, daps_UplinkPowerConfig_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_19 = {
	sizeof(struct ReconfigurationWithSync__ext2),
	offsetof(struct ReconfigurationWithSync__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext3_21[] = {
	{ ATF_POINTER, 1, offsetof(struct ReconfigurationWithSync__ext3, sl_PathSwitchConfig_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_21 = {
	sizeof(struct ReconfigurationWithSync__ext3),
	offsetof(struct ReconfigurationWithSync__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_ReconfigurationWithSync_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct ReconfigurationWithSync, rach_ConfigDedicated),
	...
	{ ATF_POINTER, 3, offsetof(struct ReconfigurationWithSync, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_17,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct ReconfigurationWithSync, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_19,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct ReconfigurationWithSync, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_21,
		0,
...
static const int asn_MAP_ReconfigurationWithSync_oms_1[] = { 0, 3, 4, 5, 6 };
