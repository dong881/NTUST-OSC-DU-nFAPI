...
static asn_per_constraints_t asn_PER_type_idleModeMeasVoiceFallback_r17_constr_11 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
	{ ATF_POINTER, 1, offsetof(struct SIB5__ext1, carrierFreqListEUTRA_v1610),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_7 = {
	sizeof(struct SIB5__ext1),
	offsetof(struct SIB5__ext1, _asn_ctx),
...
static const asn_INTEGER_enum_map_t asn_MAP_idleModeMeasVoiceFallback_r17_value2enum_11[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_idleModeMeasVoiceFallback_r17_enum2value_11[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_idleModeMeasVoiceFallback_r17_specs_11 = {
	asn_MAP_idleModeMeasVoiceFallback_r17_value2enum_11,	/* "tag" => N; sorted by tag */
	asn_MAP_idleModeMeasVoiceFallback_r17_enum2value_11,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_idleModeMeasVoiceFallback_r17_tags_11[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_idleModeMeasVoiceFallback_r17_11 = {
	"idleModeMeasVoiceFallback-r17",
	"idleModeMeasVoiceFallback-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_idleModeMeasVoiceFallback_r17_tags_11,
	sizeof(asn_DEF_idleModeMeasVoiceFallback_r17_tags_11)
		/sizeof(asn_DEF_idleModeMeasVoiceFallback_r17_tags_11[0]) - 1, /* 1 */
	asn_DEF_idleModeMeasVoiceFallback_r17_tags_11,	/* Same as above */
	sizeof(asn_DEF_idleModeMeasVoiceFallback_r17_tags_11)
		/sizeof(asn_DEF_idleModeMeasVoiceFallback_r17_tags_11[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_idleModeMeasVoiceFallback_r17_constr_11,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	&asn_SPC_idleModeMeasVoiceFallback_r17_specs_11	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_9[] = {
	{ ATF_POINTER, 2, offsetof(struct SIB5__ext2, carrierFreqListEUTRA_v1700),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SIB5__ext2, idleModeMeasVoiceFallback_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_idleModeMeasVoiceFallback_r17_11,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_9 = {
	sizeof(struct SIB5__ext2),
	offsetof(struct SIB5__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SIB5_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct SIB5, t_ReselectionEUTRA_SF),
	...
	{ ATF_POINTER, 3, offsetof(struct SIB5, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 2, offsetof(struct SIB5, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SIB5, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_9,
		0,
...
static const int asn_MAP_SIB5_oms_1[] = { 0, 2, 3, 4, 5 };
