...
static asn_per_constraints_t asn_PER_type_useAutonomousGaps_r16_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_useAutonomousGaps_r16_value2enum_5[] = {
	{ 0,	5,	"setup" }
};
static const unsigned int asn_MAP_useAutonomousGaps_r16_enum2value_5[] = {
	0	/* setup(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_useAutonomousGaps_r16_specs_5 = {
	asn_MAP_useAutonomousGaps_r16_value2enum_5,	/* "tag" => N; sorted by tag */
	asn_MAP_useAutonomousGaps_r16_enum2value_5,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_useAutonomousGaps_r16_tags_5[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_useAutonomousGaps_r16_5 = {
	"useAutonomousGaps-r16",
	"useAutonomousGaps-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_useAutonomousGaps_r16_tags_5,
	sizeof(asn_DEF_useAutonomousGaps_r16_tags_5)
		/sizeof(asn_DEF_useAutonomousGaps_r16_tags_5[0]) - 1, /* 1 */
	asn_DEF_useAutonomousGaps_r16_tags_5,	/* Same as above */
	sizeof(asn_DEF_useAutonomousGaps_r16_tags_5)
		/sizeof(asn_DEF_useAutonomousGaps_r16_tags_5[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_useAutonomousGaps_r16_constr_5,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	&asn_SPC_useAutonomousGaps_r16_specs_5	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_4[] = {
	{ ATF_POINTER, 1, offsetof(struct ReportCGI_EUTRA__ext1, useAutonomousGaps_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_useAutonomousGaps_r16_5,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_4 = {
	sizeof(struct ReportCGI_EUTRA__ext1),
	offsetof(struct ReportCGI_EUTRA__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_ReportCGI_EUTRA_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ReportCGI_EUTRA, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_4,
		0,
