...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
	{ ATF_POINTER, 2, offsetof(struct DownlinkConfigCommonSIB__ext1, pei_Config_r17),
	...
	{ ATF_POINTER, 1, offsetof(struct DownlinkConfigCommonSIB__ext1, initialDownlinkBWP_RedCap_r17),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_7 = {
	sizeof(struct DownlinkConfigCommonSIB__ext1),
	offsetof(struct DownlinkConfigCommonSIB__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_DownlinkConfigCommonSIB_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct DownlinkConfigCommonSIB, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
...
static const int asn_MAP_DownlinkConfigCommonSIB_oms_1[] = { 4 };
...
asn_SEQUENCE_specifics_t asn_SPC_DownlinkConfigCommonSIB_specs_1 = {
	...
	asn_MAP_DownlinkConfigCommonSIB_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */
