...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_spCell_BFR_CBRA_r16_constr_35 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ext1_29[] = {
	{ ATF_POINTER, 1, offsetof(struct BeamFailureRecoveryConfig__ext1, msg1_SubcarrierSpacing),
...
static asn_TYPE_member_t asn_MBR_ext2_31[] = {
	{ ATF_POINTER, 2, offsetof(struct BeamFailureRecoveryConfig__ext2, ra_PrioritizationTwoStep_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct BeamFailureRecoveryConfig__ext2, candidateBeamRSListExt_v1610),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_CandidateBeamRSListExt_r16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext2_oms_31[] = { 0, 1 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_31 = {
	sizeof(struct BeamFailureRecoveryConfig__ext2),
	offsetof(struct BeamFailureRecoveryConfig__ext2, _asn_ctx),
	asn_MAP_ext2_tag2el_31,
	2,	/* Count of tags in the map */
	asn_MAP_ext2_oms_31,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
...
static const asn_INTEGER_enum_map_t asn_MAP_spCell_BFR_CBRA_r16_value2enum_35[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_spCell_BFR_CBRA_r16_enum2value_35[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_spCell_BFR_CBRA_r16_specs_35 = {
	asn_MAP_spCell_BFR_CBRA_r16_value2enum_35,	/* "tag" => N; sorted by tag */
	asn_MAP_spCell_BFR_CBRA_r16_enum2value_35,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_spCell_BFR_CBRA_r16_tags_35[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_spCell_BFR_CBRA_r16_35 = {
	"spCell-BFR-CBRA-r16",
	"spCell-BFR-CBRA-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_spCell_BFR_CBRA_r16_tags_35,
	sizeof(asn_DEF_spCell_BFR_CBRA_r16_tags_35)
		/sizeof(asn_DEF_spCell_BFR_CBRA_r16_tags_35[0]) - 1, /* 1 */
	asn_DEF_spCell_BFR_CBRA_r16_tags_35,	/* Same as above */
	sizeof(asn_DEF_spCell_BFR_CBRA_r16_tags_35)
		/sizeof(asn_DEF_spCell_BFR_CBRA_r16_tags_35[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_spCell_BFR_CBRA_r16_constr_35,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_spCell_BFR_CBRA_r16_specs_35	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext3_34[] = {
	{ ATF_POINTER, 1, offsetof(struct BeamFailureRecoveryConfig__ext3, spCell_BFR_CBRA_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_spCell_BFR_CBRA_r16_35,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext3_oms_34[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext3_tags_34[] = {
	(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext3_tag2el_34[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* spCell-BFR-CBRA-r16 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_34 = {
	sizeof(struct BeamFailureRecoveryConfig__ext3),
	offsetof(struct BeamFailureRecoveryConfig__ext3, _asn_ctx),
	asn_MAP_ext3_tag2el_34,
	1,	/* Count of tags in the map */
	asn_MAP_ext3_oms_34,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext3_34 = {
	"ext3",
	"ext3",
	&asn_OP_SEQUENCE,
	asn_DEF_ext3_tags_34,
	sizeof(asn_DEF_ext3_tags_34)
		/sizeof(asn_DEF_ext3_tags_34[0]) - 1, /* 1 */
	asn_DEF_ext3_tags_34,	/* Same as above */
	sizeof(asn_DEF_ext3_tags_34)
		/sizeof(asn_DEF_ext3_tags_34[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_ext3_34,
	1,	/* Elements count */
	&asn_SPC_ext3_specs_34	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_BeamFailureRecoveryConfig_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct BeamFailureRecoveryConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext1_29,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct BeamFailureRecoveryConfig, ext2),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext2_31,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct BeamFailureRecoveryConfig, ext3),
		(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
		0,
		&asn_DEF_ext3_34,
		0,
