...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_secondaryDRX_Group_r16_constr_16 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_enhancedSkipUplinkTxDynamic_r16_constr_19 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_enhancedSkipUplinkTxConfigured_r16_constr_21 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_secondaryDRX_Group_r16_value2enum_16[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_secondaryDRX_Group_r16_enum2value_16[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_secondaryDRX_Group_r16_specs_16 = {
	asn_MAP_secondaryDRX_Group_r16_value2enum_16,	/* "tag" => N; sorted by tag */
	asn_MAP_secondaryDRX_Group_r16_enum2value_16,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_secondaryDRX_Group_r16_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_secondaryDRX_Group_r16_16 = {
	"secondaryDRX-Group-r16",
	"secondaryDRX-Group-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_secondaryDRX_Group_r16_tags_16,
	sizeof(asn_DEF_secondaryDRX_Group_r16_tags_16)
		/sizeof(asn_DEF_secondaryDRX_Group_r16_tags_16[0]) - 1, /* 1 */
	asn_DEF_secondaryDRX_Group_r16_tags_16,	/* Same as above */
	sizeof(asn_DEF_secondaryDRX_Group_r16_tags_16)
		/sizeof(asn_DEF_secondaryDRX_Group_r16_tags_16[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_secondaryDRX_Group_r16_constr_16,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_secondaryDRX_Group_r16_specs_16	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_15[] = {
	{ ATF_POINTER, 1, offsetof(struct MAC_ParametersXDD_Diff__ext1, secondaryDRX_Group_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_secondaryDRX_Group_r16_16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_15 = {
	sizeof(struct MAC_ParametersXDD_Diff__ext1),
	offsetof(struct MAC_ParametersXDD_Diff__ext1, _asn_ctx),
...
static const asn_INTEGER_enum_map_t asn_MAP_enhancedSkipUplinkTxDynamic_r16_value2enum_19[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_enhancedSkipUplinkTxDynamic_r16_enum2value_19[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_enhancedSkipUplinkTxDynamic_r16_specs_19 = {
	asn_MAP_enhancedSkipUplinkTxDynamic_r16_value2enum_19,	/* "tag" => N; sorted by tag */
	asn_MAP_enhancedSkipUplinkTxDynamic_r16_enum2value_19,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_enhancedSkipUplinkTxDynamic_r16_tags_19[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_enhancedSkipUplinkTxDynamic_r16_19 = {
	"enhancedSkipUplinkTxDynamic-r16",
	"enhancedSkipUplinkTxDynamic-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_enhancedSkipUplinkTxDynamic_r16_tags_19,
	sizeof(asn_DEF_enhancedSkipUplinkTxDynamic_r16_tags_19)
		/sizeof(asn_DEF_enhancedSkipUplinkTxDynamic_r16_tags_19[0]) - 1, /* 1 */
	asn_DEF_enhancedSkipUplinkTxDynamic_r16_tags_19,	/* Same as above */
	sizeof(asn_DEF_enhancedSkipUplinkTxDynamic_r16_tags_19)
		/sizeof(asn_DEF_enhancedSkipUplinkTxDynamic_r16_tags_19[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_enhancedSkipUplinkTxDynamic_r16_constr_19,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_enhancedSkipUplinkTxDynamic_r16_specs_19	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_enhancedSkipUplinkTxConfigured_r16_value2enum_21[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_enhancedSkipUplinkTxConfigured_r16_enum2value_21[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_enhancedSkipUplinkTxConfigured_r16_specs_21 = {
	asn_MAP_enhancedSkipUplinkTxConfigured_r16_value2enum_21,	/* "tag" => N; sorted by tag */
	asn_MAP_enhancedSkipUplinkTxConfigured_r16_enum2value_21,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_enhancedSkipUplinkTxConfigured_r16_tags_21[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_enhancedSkipUplinkTxConfigured_r16_21 = {
	"enhancedSkipUplinkTxConfigured-r16",
	"enhancedSkipUplinkTxConfigured-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_enhancedSkipUplinkTxConfigured_r16_tags_21,
	sizeof(asn_DEF_enhancedSkipUplinkTxConfigured_r16_tags_21)
		/sizeof(asn_DEF_enhancedSkipUplinkTxConfigured_r16_tags_21[0]) - 1, /* 1 */
	asn_DEF_enhancedSkipUplinkTxConfigured_r16_tags_21,	/* Same as above */
	sizeof(asn_DEF_enhancedSkipUplinkTxConfigured_r16_tags_21)
		/sizeof(asn_DEF_enhancedSkipUplinkTxConfigured_r16_tags_21[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_enhancedSkipUplinkTxConfigured_r16_constr_21,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_enhancedSkipUplinkTxConfigured_r16_specs_21	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_18[] = {
	{ ATF_POINTER, 2, offsetof(struct MAC_ParametersXDD_Diff__ext2, enhancedSkipUplinkTxDynamic_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_enhancedSkipUplinkTxDynamic_r16_19,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct MAC_ParametersXDD_Diff__ext2, enhancedSkipUplinkTxConfigured_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_enhancedSkipUplinkTxConfigured_r16_21,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_18 = {
	sizeof(struct MAC_ParametersXDD_Diff__ext2),
	offsetof(struct MAC_ParametersXDD_Diff__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MAC_ParametersXDD_Diff_1[] = {
	{ ATF_POINTER, 8, offsetof(struct MAC_ParametersXDD_Diff, skipUplinkTxDynamic),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct MAC_ParametersXDD_Diff, logicalChannelSR_DelayTimer),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct MAC_ParametersXDD_Diff, longDRX_Cycle),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct MAC_ParametersXDD_Diff, shortDRX_Cycle),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct MAC_ParametersXDD_Diff, multipleSR_Configurations),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct MAC_ParametersXDD_Diff, multipleConfiguredGrants),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct MAC_ParametersXDD_Diff, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_15,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct MAC_ParametersXDD_Diff, ext2),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext2_18,
		0,
...
static const int asn_MAP_MAC_ParametersXDD_Diff_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
