...
typedef enum MRDC_Parameters__ext1__intraBandENDC_Support {
	MRDC_Parameters__ext1__intraBandENDC_Support_non_contiguous	= 0,
	MRDC_Parameters__ext1__intraBandENDC_Support_both	= 1
} e_MRDC_Parameters__ext1__intraBandENDC_Support;
...
/* extern asn_TYPE_descriptor_t asn_DEF_intraBandENDC_Support_23;	// (Use -fall-defs-global to expose) */
