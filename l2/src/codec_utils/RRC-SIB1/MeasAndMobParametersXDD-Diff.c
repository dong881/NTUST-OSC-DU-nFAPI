...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_sftd_MeasNR_Neigh_constr_15 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_sftd_MeasNR_Neigh_DRX_constr_17 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_handoverLTE_EPC_constr_10,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_handoverLTE_5GC_constr_12,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static const asn_INTEGER_enum_map_t asn_MAP_sftd_MeasNR_Neigh_value2enum_15[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_sftd_MeasNR_Neigh_enum2value_15[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_sftd_MeasNR_Neigh_specs_15 = {
	asn_MAP_sftd_MeasNR_Neigh_value2enum_15,	/* "tag" => N; sorted by tag */
	asn_MAP_sftd_MeasNR_Neigh_enum2value_15,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_sftd_MeasNR_Neigh_tags_15[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_sftd_MeasNR_Neigh_15 = {
	"sftd-MeasNR-Neigh",
	"sftd-MeasNR-Neigh",
	&asn_OP_NativeEnumerated,
	asn_DEF_sftd_MeasNR_Neigh_tags_15,
	sizeof(asn_DEF_sftd_MeasNR_Neigh_tags_15)
		/sizeof(asn_DEF_sftd_MeasNR_Neigh_tags_15[0]) - 1, /* 1 */
	asn_DEF_sftd_MeasNR_Neigh_tags_15,	/* Same as above */
	sizeof(asn_DEF_sftd_MeasNR_Neigh_tags_15)
		/sizeof(asn_DEF_sftd_MeasNR_Neigh_tags_15[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_sftd_MeasNR_Neigh_constr_15,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_sftd_MeasNR_Neigh_specs_15	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_sftd_MeasNR_Neigh_DRX_value2enum_17[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_sftd_MeasNR_Neigh_DRX_enum2value_17[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_sftd_MeasNR_Neigh_DRX_specs_17 = {
	asn_MAP_sftd_MeasNR_Neigh_DRX_value2enum_17,	/* "tag" => N; sorted by tag */
	asn_MAP_sftd_MeasNR_Neigh_DRX_enum2value_17,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_sftd_MeasNR_Neigh_DRX_tags_17[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_sftd_MeasNR_Neigh_DRX_17 = {
	"sftd-MeasNR-Neigh-DRX",
	"sftd-MeasNR-Neigh-DRX",
	&asn_OP_NativeEnumerated,
	asn_DEF_sftd_MeasNR_Neigh_DRX_tags_17,
	sizeof(asn_DEF_sftd_MeasNR_Neigh_DRX_tags_17)
		/sizeof(asn_DEF_sftd_MeasNR_Neigh_DRX_tags_17[0]) - 1, /* 1 */
	asn_DEF_sftd_MeasNR_Neigh_DRX_tags_17,	/* Same as above */
	sizeof(asn_DEF_sftd_MeasNR_Neigh_DRX_tags_17)
		/sizeof(asn_DEF_sftd_MeasNR_Neigh_DRX_tags_17[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_sftd_MeasNR_Neigh_DRX_constr_17,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_sftd_MeasNR_Neigh_DRX_specs_17	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_14[] = {
	{ ATF_POINTER, 2, offsetof(struct MeasAndMobParametersXDD_Diff__ext2, sftd_MeasNR_Neigh),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_sftd_MeasNR_Neigh_15,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct MeasAndMobParametersXDD_Diff__ext2, sftd_MeasNR_Neigh_DRX),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_sftd_MeasNR_Neigh_DRX_17,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_14 = {
	sizeof(struct MeasAndMobParametersXDD_Diff__ext2),
	offsetof(struct MeasAndMobParametersXDD_Diff__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext3_19[] = {
	{ ATF_POINTER, 1, offsetof(struct MeasAndMobParametersXDD_Diff__ext3, dummy),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dummy_20,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_19 = {
	sizeof(struct MeasAndMobParametersXDD_Diff__ext3),
	offsetof(struct MeasAndMobParametersXDD_Diff__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MeasAndMobParametersXDD_Diff_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct MeasAndMobParametersXDD_Diff, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct MeasAndMobParametersXDD_Diff, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext2_14,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct MeasAndMobParametersXDD_Diff, ext3),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext3_19,
		0,
