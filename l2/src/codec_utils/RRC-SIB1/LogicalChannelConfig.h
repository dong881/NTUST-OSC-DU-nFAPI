...
typedef enum LogicalChannelConfig__ul_SpecificParameters__maxPUSCH_Duration {
	...
	LogicalChannelConfig__ul_SpecificParameters__maxPUSCH_Duration_ms0p01_v1700	= 6,
...
typedef enum LogicalChannelConfig__ul_SpecificParameters__ext1__allowedPHY_PriorityIndex_r16 {
	LogicalChannelConfig__ul_SpecificParameters__ext1__allowedPHY_PriorityIndex_r16_p0	= 0,
	LogicalChannelConfig__ul_SpecificParameters__ext1__allowedPHY_PriorityIndex_r16_p1	= 1
} e_LogicalChannelConfig__ul_SpecificParameters__ext1__allowedPHY_PriorityIndex_r16;
typedef enum LogicalChannelConfig__ul_SpecificParameters__ext2__allowedHARQ_mode_r17 {
	LogicalChannelConfig__ul_SpecificParameters__ext2__allowedHARQ_mode_r17_harqModeA	= 0,
	LogicalChannelConfig__ul_SpecificParameters__ext2__allowedHARQ_mode_r17_harqModeB	= 1
} e_LogicalChannelConfig__ul_SpecificParameters__ext2__allowedHARQ_mode_r17;
typedef enum LogicalChannelConfig__ext1__bitRateMultiplier_r16 {
	LogicalChannelConfig__ext1__bitRateMultiplier_r16_x40	= 0,
	LogicalChannelConfig__ext1__bitRateMultiplier_r16_x70	= 1,
	LogicalChannelConfig__ext1__bitRateMultiplier_r16_x100	= 2,
	LogicalChannelConfig__ext1__bitRateMultiplier_r16_x200	= 3
} e_LogicalChannelConfig__ext1__bitRateMultiplier_r16;
...
typedef struct LogicalChannelConfig {
	struct LogicalChannelConfig__ul_SpecificParameters {
		...
		struct LogicalChannelConfig__ul_SpecificParameters__ext1 {
			struct LogicalChannelConfig__ul_SpecificParameters__ext1__allowedCG_List_r16 {
		...
		struct LogicalChannelConfig__ul_SpecificParameters__ext2 {
...
/* extern asn_TYPE_descriptor_t asn_DEF_allowedPHY_PriorityIndex_r16_70;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_allowedHARQ_mode_r17_75;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_bitRateMultiplier_r16_81;	// (Use -fall-defs-global to expose) */
