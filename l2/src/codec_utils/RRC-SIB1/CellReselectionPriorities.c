...
static asn_TYPE_member_t asn_MBR_ext1_14[] = {
	{ ATF_POINTER, 1, offsetof(struct CellReselectionPriorities__ext1, freqPriorityListDedicatedSlicing_r17),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_14 = {
	sizeof(struct CellReselectionPriorities__ext1),
	offsetof(struct CellReselectionPriorities__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_CellReselectionPriorities_1[] = {
	{ ATF_POINTER, 4, offsetof(struct CellReselectionPriorities, freqPriorityListEUTRA),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct CellReselectionPriorities, freqPriorityListNR),
	...
	{ ATF_POINTER, 2, offsetof(struct CellReselectionPriorities, t320),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_t320_4,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct CellReselectionPriorities, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_14,
		0,
...
static const int asn_MAP_CellReselectionPriorities_oms_1[] = { 0, 1, 2, 3 };
