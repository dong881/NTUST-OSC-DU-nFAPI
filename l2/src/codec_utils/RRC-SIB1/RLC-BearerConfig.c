...
static asn_TYPE_member_t asn_MBR_ext1_11[] = {
	{ ATF_POINTER, 1, offsetof(struct RLC_BearerConfig__ext1, rlc_Config_v1610),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_11 = {
	sizeof(struct RLC_BearerConfig__ext1),
	offsetof(struct RLC_BearerConfig__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext2_13[] = {
	{ ATF_POINTER, 4, offsetof(struct RLC_BearerConfig__ext2, rlc_Config_v1700),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct RLC_BearerConfig__ext2, logicalChannelIdentityExt_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct RLC_BearerConfig__ext2, multicastRLC_BearerConfig_r17),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct RLC_BearerConfig__ext2, servedRadioBearerSRB4_r17),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_13 = {
	sizeof(struct RLC_BearerConfig__ext2),
	offsetof(struct RLC_BearerConfig__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RLC_BearerConfig_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct RLC_BearerConfig, servedRadioBearer),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_POINTER, 5, offsetof(struct RLC_BearerConfig, reestablishRLC),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct RLC_BearerConfig, rlc_Config),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_RLC_Config,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct RLC_BearerConfig, mac_LogicalChannelConfig),
	...
	{ ATF_POINTER, 2, offsetof(struct RLC_BearerConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext1_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RLC_BearerConfig, ext2),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext2_13,
		0,
...
static const int asn_MAP_RLC_BearerConfig_oms_1[] = { 1, 2, 3, 4, 5, 6 };
