...
static asn_TYPE_member_t asn_MBR_ext1_4[] = {
	{ ATF_POINTER, 1, offsetof(struct ReportCGI__ext1, useAutonomousGaps_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_4 = {
	sizeof(struct ReportCGI__ext1),
	offsetof(struct ReportCGI__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_ReportCGI_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ReportCGI, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_4,
		0,
