...
static asn_TYPE_member_t asn_MBR_criticalExtensionsFuture_r16_4[] = {
	{ ATF_POINTER, 0, offsetof(struct SystemInformation__criticalExtensions__criticalExtensionsFuture_r16, choice.posSystemInformation_r16),
	...
	{ ATF_POINTER, 0, offsetof(struct SystemInformation__criticalExtensions__criticalExtensionsFuture_r16, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SystemInformation__criticalExtensions, choice.criticalExtensionsFuture_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
