...
typedef enum MeasConfig__ext1__interFrequencyConfig_NoGap_r16 {
	MeasConfig__ext1__interFrequencyConfig_NoGap_r16_true	= 0
} e_MeasConfig__ext1__interFrequencyConfig_NoGap_r16;
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_interFrequencyConfig_NoGap_r16_16;	// (Use -fall-defs-global to expose) */
