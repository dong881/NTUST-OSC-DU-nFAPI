...
static asn_TYPE_member_t asn_MBR_reportType_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigNR__reportType, choice.reportSFTD),
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigNR__reportType, choice.condTriggerConfig_r16),
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigNR__reportType, choice.cli_Periodical_r16),
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigNR__reportType, choice.cli_EventTriggered_r16),
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigNR__reportType, choice.rxTxPeriodical_r17),
