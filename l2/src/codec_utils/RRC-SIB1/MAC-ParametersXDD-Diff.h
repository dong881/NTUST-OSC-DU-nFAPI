...
typedef enum MAC_ParametersXDD_Diff__ext1__secondaryDRX_Group_r16 {
	MAC_ParametersXDD_Diff__ext1__secondaryDRX_Group_r16_supported	= 0
} e_MAC_ParametersXDD_Diff__ext1__secondaryDRX_Group_r16;
typedef enum MAC_ParametersXDD_Diff__ext2__enhancedSkipUplinkTxDynamic_r16 {
	MAC_ParametersXDD_Diff__ext2__enhancedSkipUplinkTxDynamic_r16_supported	= 0
} e_MAC_ParametersXDD_Diff__ext2__enhancedSkipUplinkTxDynamic_r16;
typedef enum MAC_ParametersXDD_Diff__ext2__enhancedSkipUplinkTxConfigured_r16 {
	MAC_ParametersXDD_Diff__ext2__enhancedSkipUplinkTxConfigured_r16_supported	= 0
} e_MAC_ParametersXDD_Diff__ext2__enhancedSkipUplinkTxConfigured_r16;
...
typedef struct MAC_ParametersXDD_Diff {
	 ...
	 */
	struct MAC_ParametersXDD_Diff__ext1 {
		long	*secondaryDRX_Group_r16;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext1;
	struct MAC_ParametersXDD_Diff__ext2 {
...
/* extern asn_TYPE_descriptor_t asn_DEF_secondaryDRX_Group_r16_16;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_enhancedSkipUplinkTxDynamic_r16_19;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_enhancedSkipUplinkTxConfigured_r16_21;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_MAC_ParametersXDD_Diff_1[8];
