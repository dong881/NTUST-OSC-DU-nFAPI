...
static asn_TYPE_member_t asn_MBR_ext2_7[] = {
	{ ATF_POINTER, 2, offsetof(struct QuantityConfig__ext2, quantityConfigUTRA_FDD_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct QuantityConfig__ext2, quantityConfigCLI_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
asn_TYPE_member_t asn_MBR_QuantityConfig_1[] = {
	{ ATF_POINTER, 3, offsetof(struct QuantityConfig, quantityConfigNR_List),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct QuantityConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct QuantityConfig, ext2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext2_7,
		0,
...
static const int asn_MAP_QuantityConfig_oms_1[] = { 0, 1, 2 };
