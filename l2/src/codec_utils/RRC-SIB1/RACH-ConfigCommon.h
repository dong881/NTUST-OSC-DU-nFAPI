...
typedef enum RACH_ConfigCommon__ext1__prach_RootSequenceIndex_r16_PR {
	RACH_ConfigCommon__ext1__prach_RootSequenceIndex_r16_PR_NOTHING,	/* No components present */
	RACH_ConfigCommon__ext1__prach_RootSequenceIndex_r16_PR_l571,
	RACH_ConfigCommon__ext1__prach_RootSequenceIndex_r16_PR_l1151
} RACH_ConfigCommon__ext1__prach_RootSequenceIndex_r16_PR;

/* Forward declarations */
struct RA_PrioritizationForSlicing_r17;
struct FeatureCombinationPreambles_r17;
...
typedef struct RACH_ConfigCommon {
	...
	struct RACH_ConfigCommon__ext1 {
		struct RACH_ConfigCommon__ext1__ra_PrioritizationForAccessIdentity_r16 {
		...
		struct RACH_ConfigCommon__ext1__prach_RootSequenceIndex_r16 {
			RACH_ConfigCommon__ext1__prach_RootSequenceIndex_r16_PR present;
			union RACH_ConfigCommon__ext1__prach_RootSequenceIndex_r16_u {
				long	 l571;
				long	 l1151;
			} choice;
	...
	struct RACH_ConfigCommon__ext2 {
		struct RA_PrioritizationForSlicing_r17	*ra_PrioritizationForSlicing_r17;	/* OPTIONAL */
		struct RACH_ConfigCommon__ext2__featureCombinationPreamblesList_r17 {
			A_SEQUENCE_OF(struct FeatureCombinationPreambles_r17) list;
