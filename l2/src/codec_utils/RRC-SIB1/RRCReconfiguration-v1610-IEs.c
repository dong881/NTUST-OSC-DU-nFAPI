...
static asn_per_constraints_t asn_PER_type_daps_SourceRelease_r16_constr_6 CC_NOTUSED = {
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_dedicatedPosSysInfoDelivery_r16_constr_11 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_SEMI_CONSTRAINED,	-1, -1,  0,  0 }	/* (SIZE(0..MAX)) */,
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_daps_SourceRelease_r16_value2enum_6[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_daps_SourceRelease_r16_enum2value_6[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_daps_SourceRelease_r16_specs_6 = {
	asn_MAP_daps_SourceRelease_r16_value2enum_6,	/* "tag" => N; sorted by tag */
	asn_MAP_daps_SourceRelease_r16_enum2value_6,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_daps_SourceRelease_r16_tags_6[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_daps_SourceRelease_r16_6 = {
	"daps-SourceRelease-r16",
	"daps-SourceRelease-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_daps_SourceRelease_r16_tags_6,
	sizeof(asn_DEF_daps_SourceRelease_r16_tags_6)
		/sizeof(asn_DEF_daps_SourceRelease_r16_tags_6[0]) - 1, /* 1 */
	asn_DEF_daps_SourceRelease_r16_tags_6,	/* Same as above */
	sizeof(asn_DEF_daps_SourceRelease_r16_tags_6)
		/sizeof(asn_DEF_daps_SourceRelease_r16_tags_6[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_daps_SourceRelease_r16_constr_6,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	&asn_SPC_daps_SourceRelease_r16_specs_6	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_RRCReconfiguration_v1610_IEs_1[] = {
	...
	{ ATF_POINTER, 12, offsetof(struct RRCReconfiguration_v1610_IEs, bap_Config_r16),
		...
		&asn_DEF_SetupRelease_BAP_Config_r16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 9, offsetof(struct RRCReconfiguration_v1610_IEs, daps_SourceRelease_r16),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_daps_SourceRelease_r16_6,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 7, offsetof(struct RRCReconfiguration_v1610_IEs, needForGapsConfigNR_r16),
		...
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_NeedForGapsConfigNR_r16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 6, offsetof(struct RRCReconfiguration_v1610_IEs, onDemandSIB_Request_r16),
		...
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_OnDemandSIB_Request_r16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_dedicatedPosSysInfoDelivery_r16_constr_11,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_dedicatedPosSysInfoDelivery_r16_constraint_1
		},
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 3, offsetof(struct RRCReconfiguration_v1610_IEs, sl_ConfigDedicatedEUTRA_Info_r16),
		...
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_SL_ConfigDedicatedEUTRA_Info_r16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 2, offsetof(struct RRCReconfiguration_v1610_IEs, targetCellSMTC_SCG_r16),
