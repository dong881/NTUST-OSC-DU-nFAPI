 ...
 */
static int
memb_choConfig_r17_constraint_13(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_choCandidate_r17_constr_14 CC_NOTUSED = {
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_choConfig_r17_constr_16 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_firstTriggeredEvent_constr_20 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_choConfig_r17_constr_16 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 1,  1,  1,  2 }	/* (SIZE(1..2)) */,
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_choCandidate_r17_value2enum_14[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_choCandidate_r17_enum2value_14[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_choCandidate_r17_specs_14 = {
	asn_MAP_choCandidate_r17_value2enum_14,	/* "tag" => N; sorted by tag */
	asn_MAP_choCandidate_r17_enum2value_14,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_choCandidate_r17_tags_14[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_choCandidate_r17_14 = {
	"choCandidate-r17",
	"choCandidate-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_choCandidate_r17_tags_14,
	sizeof(asn_DEF_choCandidate_r17_tags_14)
		/sizeof(asn_DEF_choCandidate_r17_tags_14[0]) - 1, /* 1 */
	asn_DEF_choCandidate_r17_tags_14,	/* Same as above */
	sizeof(asn_DEF_choCandidate_r17_tags_14)
		/sizeof(asn_DEF_choCandidate_r17_tags_14[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_choCandidate_r17_constr_14,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	&asn_SPC_choCandidate_r17_specs_14	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_choConfig_r17_16[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_choConfig_r17_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_choConfig_r17_specs_16 = {
	sizeof(struct MeasResultNR__ext2__choConfig_r17),
	offsetof(struct MeasResultNR__ext2__choConfig_r17, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_choConfig_r17_16 = {
	"choConfig-r17",
	"choConfig-r17",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_choConfig_r17_tags_16,
	sizeof(asn_DEF_choConfig_r17_tags_16)
		/sizeof(asn_DEF_choConfig_r17_tags_16[0]) - 1, /* 1 */
	asn_DEF_choConfig_r17_tags_16,	/* Same as above */
	sizeof(asn_DEF_choConfig_r17_tags_16)
		/sizeof(asn_DEF_choConfig_r17_tags_16[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_choConfig_r17_constr_16,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	asn_MBR_choConfig_r17_16,
	1,	/* Single element */
	&asn_SPC_choConfig_r17_specs_16	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_firstTriggeredEvent_value2enum_20[] = {
	{ 0,	14,	"condFirstEvent" },
	{ 1,	15,	"condSecondEvent" }
};
static const unsigned int asn_MAP_firstTriggeredEvent_enum2value_20[] = {
	0,	/* condFirstEvent(0) */
	1	/* condSecondEvent(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_firstTriggeredEvent_specs_20 = {
	asn_MAP_firstTriggeredEvent_value2enum_20,	/* "tag" => N; sorted by tag */
	asn_MAP_firstTriggeredEvent_enum2value_20,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_firstTriggeredEvent_tags_20[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_firstTriggeredEvent_20 = {
	"firstTriggeredEvent",
	"firstTriggeredEvent",
	&asn_OP_NativeEnumerated,
	asn_DEF_firstTriggeredEvent_tags_20,
	sizeof(asn_DEF_firstTriggeredEvent_tags_20)
		/sizeof(asn_DEF_firstTriggeredEvent_tags_20[0]) - 1, /* 1 */
	asn_DEF_firstTriggeredEvent_tags_20,	/* Same as above */
	sizeof(asn_DEF_firstTriggeredEvent_tags_20)
		/sizeof(asn_DEF_firstTriggeredEvent_tags_20[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_firstTriggeredEvent_constr_20,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_firstTriggeredEvent_specs_20	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_triggeredEvent_r17_18[] = {
	{ ATF_POINTER, 2, offsetof(struct MeasResultNR__ext2__triggeredEvent_r17, timeBetweenEvents_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResultNR__ext2__triggeredEvent_r17, firstTriggeredEvent),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_firstTriggeredEvent_20,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_triggeredEvent_r17_oms_18[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_triggeredEvent_r17_tags_18[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_triggeredEvent_r17_tag2el_18[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* timeBetweenEvents-r17 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* firstTriggeredEvent */
};
static asn_SEQUENCE_specifics_t asn_SPC_triggeredEvent_r17_specs_18 = {
	sizeof(struct MeasResultNR__ext2__triggeredEvent_r17),
	offsetof(struct MeasResultNR__ext2__triggeredEvent_r17, _asn_ctx),
	asn_MAP_triggeredEvent_r17_tag2el_18,
	2,	/* Count of tags in the map */
	asn_MAP_triggeredEvent_r17_oms_18,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_triggeredEvent_r17_18 = {
	"triggeredEvent-r17",
	"triggeredEvent-r17",
	&asn_OP_SEQUENCE,
	asn_DEF_triggeredEvent_r17_tags_18,
	sizeof(asn_DEF_triggeredEvent_r17_tags_18)
		/sizeof(asn_DEF_triggeredEvent_r17_tags_18[0]) - 1, /* 1 */
	asn_DEF_triggeredEvent_r17_tags_18,	/* Same as above */
	sizeof(asn_DEF_triggeredEvent_r17_tags_18)
		/sizeof(asn_DEF_triggeredEvent_r17_tags_18[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_triggeredEvent_r17_18,
	2,	/* Elements count */
	&asn_SPC_triggeredEvent_r17_specs_18	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_13[] = {
	{ ATF_POINTER, 3, offsetof(struct MeasResultNR__ext2, choCandidate_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_choCandidate_r17_14,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 2, offsetof(struct MeasResultNR__ext2, choConfig_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_choConfig_r17_16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_choConfig_r17_constr_16,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_choConfig_r17_constraint_13
		},
		0, 0, /* No default value */
		"choConfig-r17"
		},
	{ ATF_POINTER, 1, offsetof(struct MeasResultNR__ext2, triggeredEvent_r17),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_triggeredEvent_r17_18,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_13 = {
	sizeof(struct MeasResultNR__ext2),
	offsetof(struct MeasResultNR__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MeasResultNR_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct MeasResultNR, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResultNR, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext2_13,
		0,
...
static const int asn_MAP_MeasResultNR_oms_1[] = { 0, 2, 3 };
