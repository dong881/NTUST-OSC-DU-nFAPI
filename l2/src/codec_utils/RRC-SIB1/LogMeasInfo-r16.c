...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_inDeviceCoexDetected_r17_constr_13 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_anyCellSelectionDetected_r16_constr_9,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static const asn_INTEGER_enum_map_t asn_MAP_inDeviceCoexDetected_r17_value2enum_13[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_inDeviceCoexDetected_r17_enum2value_13[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_inDeviceCoexDetected_r17_specs_13 = {
	asn_MAP_inDeviceCoexDetected_r17_value2enum_13,	/* "tag" => N; sorted by tag */
	asn_MAP_inDeviceCoexDetected_r17_enum2value_13,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_inDeviceCoexDetected_r17_tags_13[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_inDeviceCoexDetected_r17_13 = {
	"inDeviceCoexDetected-r17",
	"inDeviceCoexDetected-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_inDeviceCoexDetected_r17_tags_13,
	sizeof(asn_DEF_inDeviceCoexDetected_r17_tags_13)
		/sizeof(asn_DEF_inDeviceCoexDetected_r17_tags_13[0]) - 1, /* 1 */
	asn_DEF_inDeviceCoexDetected_r17_tags_13,	/* Same as above */
	sizeof(asn_DEF_inDeviceCoexDetected_r17_tags_13)
		/sizeof(asn_DEF_inDeviceCoexDetected_r17_tags_13[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_inDeviceCoexDetected_r17_constr_13,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_inDeviceCoexDetected_r17_specs_13	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_12[] = {
	{ ATF_POINTER, 1, offsetof(struct LogMeasInfo_r16__ext1, inDeviceCoexDetected_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_inDeviceCoexDetected_r17_13,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_12 = {
	sizeof(struct LogMeasInfo_r16__ext1),
	offsetof(struct LogMeasInfo_r16__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LogMeasInfo_r16_1[] = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_relativeTimeStamp_r16_constr_3,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_relativeTimeStamp_r16_constraint_1
		},
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct LogMeasInfo_r16, anyCellSelectionDetected_r16),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct LogMeasInfo_r16, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_12,
		0,
...
static const int asn_MAP_LogMeasInfo_r16_oms_1[] = { 0, 2, 3, 5, 6 };
