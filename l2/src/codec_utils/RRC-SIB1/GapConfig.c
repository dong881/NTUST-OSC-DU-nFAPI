...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_mgl_r16_constr_27 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_refServCellIndicator_constr_21,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static const asn_INTEGER_enum_map_t asn_MAP_mgl_r16_value2enum_27[] = {
	{ 0,	4,	"ms10" },
	{ 1,	4,	"ms20" }
};
static const unsigned int asn_MAP_mgl_r16_enum2value_27[] = {
	0,	/* ms10(0) */
	1	/* ms20(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_mgl_r16_specs_27 = {
	asn_MAP_mgl_r16_value2enum_27,	/* "tag" => N; sorted by tag */
	asn_MAP_mgl_r16_enum2value_27,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_mgl_r16_tags_27[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_mgl_r16_27 = {
	"mgl-r16",
	"mgl-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_mgl_r16_tags_27,
	sizeof(asn_DEF_mgl_r16_tags_27)
		/sizeof(asn_DEF_mgl_r16_tags_27[0]) - 1, /* 1 */
	asn_DEF_mgl_r16_tags_27,	/* Same as above */
	sizeof(asn_DEF_mgl_r16_tags_27)
		/sizeof(asn_DEF_mgl_r16_tags_27[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_mgl_r16_constr_27,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_mgl_r16_specs_27	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_25[] = {
	{ ATF_POINTER, 2, offsetof(struct GapConfig__ext2, refFR2ServCellAsyncCA_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct GapConfig__ext2, mgl_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_mgl_r16_27,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_25 = {
	sizeof(struct GapConfig__ext2),
	offsetof(struct GapConfig__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_GapConfig_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct GapConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_20,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct GapConfig, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_25,
		0,
...
static const int asn_MAP_GapConfig_oms_1[] = { 4, 5 };
