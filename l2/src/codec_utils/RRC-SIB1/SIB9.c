...
static asn_TYPE_member_t asn_MBR_ext1_9[] = {
	{ ATF_POINTER, 1, offsetof(struct SIB9__ext1, referenceTimeInfo_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_9 = {
	sizeof(struct SIB9__ext1),
	offsetof(struct SIB9__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SIB9_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SIB9, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
